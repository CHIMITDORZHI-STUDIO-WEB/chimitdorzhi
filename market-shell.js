...
(function () {
  function build() {
    ...
    h += n('/blog/', 'ph-newspaper', 'Блог', false);
    h += '</div><div class="wx-cta"><div class="wx-cta-top"><span class="wx-cta-dot"></span> На связи · отвечаю за час</div><div class="wx-cta-title">Есть задача?</div><a href="https://t.me/chimitdorzhi" target="_blank" rel="noopener" class="wx-cta-btn"><i class="ph-fill ph-telegram-logo"></i> Обсудить</a></div>';
