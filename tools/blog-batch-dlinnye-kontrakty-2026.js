...
module.exports = [
  E({ slug: 'formaty-sotrudnichestva-2026', category: 'development', heroIcon: 'ph-fill ph-handshake',
    ...
    metaDescription: 'Форматы работы с разработчиком: проект под ключ, почасовая (T&M), абонентка-подписка или внешний IT-отдел. Чем отличаются, кому что подходит, ориентиры по цене и как выбрать формат.',
  ...
  E({ slug: 'vneshniy-it-direktor-cto-2026', category: 'development', heroIcon: 'ph-fill ph-user-focus',
    ...
    metaDescription: 'Внешний IT-директор (CTO as a Service): что это, кому нужен без штатного технического директора, чем занимается, как выбирает решения и подрядчиков и во сколько обходится по сравнению со штатным.',
  ...
  E({ slug: 'vneshniy-it-otdel-2026', category: 'development', heroIcon: 'ph-fill ph-users-three',
    ...
    metaDescription: 'Внешний IT-отдел: как компании без своих айтишников получить полноценную IT-функцию на аутсорсе — поддержка, разработка, инфраструктура, безопасность — за фиксированную абонентку вместо штата.',
  ...
  E({ slug: 'pilotnyy-proekt-2-nedeli-2026', category: 'development', heroIcon: 'ph-fill ph-flask',
    ...
    metaDescription: 'Пилотный проект за 2 недели: как проверить IT-подрядчика на маленькой задаче до большого контракта — что взять в пилот, как оценить результат и как снять страх «а вдруг кинет».',
  ...
  E({ slug: 'keys-6-mesyacev-cifry-2026', category: 'cases', heroIcon: 'ph-fill ph-chart-line-up',
    ...
    metaDescription: 'Обезличенный кейс сопровождения на примере типового бизнеса: что изменилось за 6 месяцев — заявки, скорость обработки, ошибки, время сотрудников. Цифры до и после и как это устроено.',
  ...
  E({ slug: 'kak-ya-rabotayu-process-2026', category: 'development', heroIcon: 'ph-fill ph-steps',
    ...
    metaDescription: 'Как я работаю над проектом: прозрачный процесс от первой задачи до релиза и поддержки — бриф, оценка, этапы с демо, приёмка, передача доступов, сопровождение. Что видит и контролирует заказчик.',
  ...
  E({ slug: 'it-strategiya-malyy-biznes-2026', category: 'development', heroIcon: 'ph-fill ph-strategy',
    ...
    metaDescription: 'IT-стратегия для малого бизнеса: как составить простой план цифровизации на год — что автоматизировать в первую очередь, чего не покупать раньше времени и как не потратить бюджет впустую.',
  ...
  E({ slug: 'pochemu-beru-ne-vse-proekty-2026', category: 'development', heroIcon: 'ph-fill ph-funnel',
    ...
    metaDescription: 'Почему я берусь не за каждый проект: какие задачи беру, а какие честно отклоняю и почему это защищает и заказчика, и качество. Как понять, подходим ли мы друг другу.',
