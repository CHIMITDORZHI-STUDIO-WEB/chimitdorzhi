...
module.exports = [
  E({ slug: 'marketplace-nezavisimyh-masterov-krasoty-2027', heroIcon: 'ph-fill ph-scissors',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса StyleSeat: платформа, где независимые мастера красоты (парикмахеры, мастера маникюра.',
  ...
  E({ slug: 'besplatnoe-bronirovanie-dlya-salona-2027', heroIcon: 'ph-fill ph-calendar-heart',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Fresha: система онлайн-записи для салонов красоты и спа предоставляется бесплатно.',
  ...
  E({ slug: 'vsyo-v-odnom-dlya-mastera-odinochki-2027', heroIcon: 'ph-fill ph-sparkle',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса GlossGenius: приложение для мастера, работающего в одиночку (парикмахер, косметолог, бровист).',
  ...
  E({ slug: 'vyezdnoy-byuti-master-na-dom-2027', heroIcon: 'ph-fill ph-lipstick',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Glamsquad: заказ визажиста или парикмахера на дом или в офис к определённому времени — перед мероприятием, свадьбой.',
  ...
  E({ slug: 'marketplace-bytovyh-uslug-na-dom-2027', heroIcon: 'ph-fill ph-wrench',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Urban Company: единое приложение, где можно заказать уборку, ремонт бытовой техники.',
  ...
  E({ slug: 'uhod-za-gazonom-marketplace-2027', heroIcon: 'ph-fill ph-plant',
    ...
    metaDescription: 'Стрижка газона по подписке с автоматическим повтором заказа вместо поиска садовника заново. Разбираю модели LawnStarter и TaskEasy для нашего рынка.',
  ...
  E({ slug: 'personalizirovannyy-shampun-pod-zakazchika-2027', heroIcon: 'ph-fill ph-drop',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Function of Beauty: покупатель отвечает на вопросы о типе волос и целях ухода.',
  ...
  E({ slug: 'koordinaciya-klinerov-mezhdu-zaezdami-2027', heroIcon: 'ph-fill ph-broom',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Turno: SaaS для владельцев и управляющих компаний посуточной аренды.',
  ...
  E({ slug: 'avtomatizaciya-pereezda-smena-adresa-2027', heroIcon: 'ph-fill ph-truck',
    ...
    metaTitle: 'Автоматизация переезда: смена адреса и подписок',
    metaDescription: 'Переезд — это десяток звонков и перенос коммунальных услуг. Разбираю модель Updater: приложение меняет адрес и услуги вместо ручного обзвона.',
