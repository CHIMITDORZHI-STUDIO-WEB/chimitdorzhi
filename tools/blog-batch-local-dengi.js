...
module.exports = [
  ...
  E({ slug: 'chat-bot-dlya-biznesa-chita-ulan-ude-2026', category: 'development', heroIcon: 'ph-fill ph-robot', toc: TOC_LOCAL(),
    ...
    metaDescription: 'Чат-бот для бизнеса в Чите и Улан-Удэ: запись, ответы 24/7, заказы, оплата, напоминания. Платформы Telegram, MAX, VK, что входит в работу и вилки цен. Местный бизнес и удалённо по РФ, с примером для кафе и салона.',
