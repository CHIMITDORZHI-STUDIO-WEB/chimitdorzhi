...
module.exports = [
  E({ slug: 'razrabotka-pod-klyuch-chita-ulan-ude-2026', category: 'development', heroIcon: 'ph-fill ph-map-pin-line',
    ...
    metaDescription: 'Разработка и автоматизация под ключ для бизнеса в Чите, Улан-Удэ, Бурятии и Забайкалье: сайты и лендинги, чат-боты, ИИ, автоматизация и CRM, реклама.',
  ...
  E({ slug: 'chat-bot-dlya-biznesa-chita-ulan-ude-2026', category: 'development', heroIcon: 'ph-fill ph-robot', toc: TOC_LOCAL(),
    ...
    metaDescription: 'Чат-бот для бизнеса в Чите и Улан-Удэ: запись, ответы 24/7, заказы, оплата, напоминания.',
  ...
  E({ slug: 'ii-dlya-biznesa-chita-ulan-ude-2026', category: 'ai-dev', heroIcon: 'ph-fill ph-sparkle', toc: TOC_LOCAL(),
    ...
    metaDescription: 'ИИ для бизнеса в Чите и Улан-Удэ: с каких задач начать (ассистент поддержки и продаж, обработка заявок, контент, документы).',
  ...
  E({ slug: 'zakazat-lending-chita-ulan-ude-2026', category: 'development', heroIcon: 'ph-fill ph-file-html', toc: TOC_LOCAL(),
    ...
    metaDescription: 'Заказать лендинг в Чите и Улан-Удэ: зачем он местному бизнесу, что входит (оффер, дизайн, копирайтинг, формы, оплата, интеграция с CRM и мессенджерами.',
  ...
  E({ slug: 'komu-zakazat-sayt-chita-ulan-ude-2026', category: 'development', heroIcon: 'ph-fill ph-users-three',
    ...
    metaDescription: 'Кому заказать сайт в Чите и Улан-Удэ: честное сравнение фрилансера, студии и частного специалиста по цене, надёжности и поддержке.',
  ...
  E({ slug: 'avtomatizaciya-kafe-magazina-chita-ulan-ude-2026', category: 'industries', heroIcon: 'ph-fill ph-storefront', toc: TOC_LOCAL(),
    ...
    metaDescription: 'Автоматизация кафе и магазина в Чите и Улан-Удэ: касса и 54-ФЗ, маркировка «Честный знак», складской учёт, программа лояльности, бот для заказов и брони.',
