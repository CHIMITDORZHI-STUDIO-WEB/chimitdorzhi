...
module.exports = [
  E({ slug: 'kak-sozdat-bota-v-max-poshagovo-2026', heroIcon: 'ph-fill ph-robot',
    ...
    metaDescription: 'Бот в мессенджере MAX с нуля: где взять токен, собрать сценарий, подключить оплату и CRM. Что реально сделать самому, а что дешевле заказать.',
  ...
  E({ slug: 'napisat-skript-na-zakaz-2026', heroIcon: 'ph-fill ph-code',
    ...
    metaDescription: 'Написать скрипт на заказ: автоматизация рутинных задач (обработка файлов, выгрузки, рассылки, переименование, сбор данных).',
  ...
  E({ slug: 'dorabotka-sayta-2026', heroIcon: 'ph-fill ph-wrench',
    ...
    metaDescription: 'Доработка сайта: доделать проект за фрилансером, который пропал, починить баги, добавить функции, ускорить и подключить к нему бота или CRM.',
  ...
  E({ slug: 'sozdat-svoy-veb-servis-saas-2026', heroIcon: 'ph-fill ph-rocket-launch',
    ...
    metaDescription: 'Как создать свой веб-сервис или SaaS под конкретный бизнес-процесс: с чего начать, что входит в MVP.',
  ...
  E({ slug: 'avtomatizaciya-excel-na-zakaz-2026', heroIcon: 'ph-fill ph-table',
    ...
    metaDescription: 'Автоматизация Excel на заказ: макросы, автоматические отчёты, связка с 1С и CRM, перенос перегруженных таблиц в базу или веб-сервис.',
