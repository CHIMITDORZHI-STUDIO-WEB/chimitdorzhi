...
module.exports = [
  E({ slug: 'rustdesk-udalennyy-dostup-2026', heroIcon: 'ph-fill ph-desktop',
    ...
    metaDescription: 'RustDesk — open-source аналог TeamViewer/AnyDesk: удалённый доступ к компьютерам со своим сервером.',
  ...
  E({ slug: 'paperless-ngx-arhiv-dokumentov-2026', heroIcon: 'ph-fill ph-files',
    ...
    metaDescription: 'Paperless-ngx — open-source электронный архив документов: сканируете и загружаете, система распознаёт текст (OCR) и ищет по содержимому.',
  ...
  E({ slug: 'send-bezopasnaya-peredacha-faylov-2026', heroIcon: 'ph-fill ph-paper-plane-tilt',
    ...
    metaDescription: 'Send (форк Firefox Send) — open-source сервер безопасной передачи файлов: end-to-end шифрование, авто-удаление после скачивания или по сроку.',
