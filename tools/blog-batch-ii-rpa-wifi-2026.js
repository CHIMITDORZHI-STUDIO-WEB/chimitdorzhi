...
module.exports = [
  ...
  E({ slug: 'bezopasnyy-ii-v-kompanii-2026', category: 'security', heroIcon: 'ph-fill ph-shield-check',
    ...
    metaDescription: 'Сотрудники грузят договоры и базы клиентов в нейросети — данные уходят на чужие серверы. Чем грозит по 152-ФЗ и как выстроить безопасный ИИ-контур.',
  ...
  E({ slug: 'ii-prognoz-sprosa-prodazh-2026', category: 'ai-dev', heroIcon: 'ph-fill ph-chart-line-up',
    ...
    metaDescription: 'ИИ-прогноз спроса: как модели считают, сколько товара понадобится, чтобы не морозить деньги в неликвиде. Какие данные нужны и с чего начать.',
  ...
  E({ slug: 'rpa-robot-v-brauzere-2026', category: 'development', heroIcon: 'ph-fill ph-robot',
    ...
    metaDescription: 'RPA простыми словами: программный робот сам заходит в личные кабинеты, выгружает отчёты, заполняет формы и сверяет данные — там, где нет API.',
  ...
  E({ slug: 'gostevoy-wifi-po-zakonu-2026', category: 'legal', heroIcon: 'ph-fill ph-wifi-high',
    ...
    metaDescription: 'Гостевой Wi-Fi в кафе, отеле, салоне: почему нельзя просто раздать пароль, что требует закон об идентификации пользователей публичных сетей.',
  ...
  E({ slug: 'ii-foto-blyud-dlya-menyu-2026', category: 'industries', heroIcon: 'ph-fill ph-image',
    ...
    metaDescription: 'Фото блюд для меню и доставки с помощью нейросетей: как быстро получить визуал без фотосессии, где это уместно.',
