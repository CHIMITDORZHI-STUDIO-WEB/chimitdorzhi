...
module.exports = [
  E({ slug: 'programma-dlya-upravleniya-arendoy-2026', category: 'industries', heroIcon: 'ph-fill ph-buildings',
    ...
    metaDescription: 'Программа для управления арендой: учёт объектов и арендаторов, договоры по шаблонам, контроль платежей и долгов, автоматические документы. Что умеют готовые решения и когда выгоднее своя система на своём сервере.',
  ...
  E({ slug: 'gps-trekking-sotrudnikov-cherez-telefon-2026', category: 'industries', heroIcon: 'ph-fill ph-device-mobile',
    ...
    metaDescription: 'GPS-трекинг выездных сотрудников через обычный смартфон: как это работает без покупки трекеров, что можно отслеживать законно по 152-ФЗ, как оформить согласия и как развернуть систему на своём сервере.',
  ...
  E({ slug: 'gps-trekking-skota-osheyniki-2026', category: 'industries', heroIcon: 'ph-fill ph-cow',
    ...
    metaDescription: 'GPS-трекинг скота на пастбище: как работают ошейники-трекеры, геозоны и оповещения об уходе стада, что делать при отсутствии связи в степи (LoRaWAN), сколько стоит и как развернуть свою систему мониторинга.',
  ...
  E({ slug: 'podschet-posetiteley-magazina-2026', category: 'industries', heroIcon: 'ph-fill ph-users-three',
    ...
    metaDescription: 'Подсчёт посетителей магазина без камер: как работают Wi-Fi и Bluetooth счётчики трафика, что они дают бизнесу (конверсия витрины, часы пик), сколько стоит и что важно учесть по 152-ФЗ.',
  ...
  E({ slug: 'svoy-konverter-dokumentov-2026', category: 'development', heroIcon: 'ph-fill ph-files',
    ...
    metaDescription: 'Свой конвертер файлов на сервере компании: PDF, Word, Excel, изображения, видео без загрузки в чужие онлайн-сервисы. Зачем это бизнесу с конфиденциальными документами и как развернуть под ключ.',
  ...
  E({ slug: 'ocifrovka-bumazhnyh-form-2026', category: 'development', heroIcon: 'ph-fill ph-file-text',
    ...
    metaDescription: 'Оцифровка бумажных бланков и анкет: как превратить PDF в заполняемые формы, собирать данные клиентов онлайн вместо бумаги, автоматически подгружать их в базу и что учесть по 152-ФЗ.',
  ...
  E({ slug: 'priznaki-shablonnogo-ii-sayta-2026', category: 'marketing', heroIcon: 'ph-fill ph-magic-wand',
    ...
    metaDescription: 'Признаки шаблонного сайта, собранного нейросетью или конструктором: одинаковые градиенты, безликие фразы, стоковые картинки, эмодзи вместо смысла. Почему это снижает доверие клиентов и как сделать сайт живым.',
