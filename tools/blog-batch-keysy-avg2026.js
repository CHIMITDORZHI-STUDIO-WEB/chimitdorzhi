...
module.exports = [
  mk({
    ...
    metaDescription: 'Кейс разработки сайта и админ-панели для сети кофеен самообслуживания «Горячий момент»: лендинг под бренд, карта точек, самостоятельное редактирование контента владельцем без программиста, два домена и 152-ФЗ.',
  ...
  mk({
    ...
    metaDescription: 'Кейс: сервис проверки кодов ТН ВЭД для декларанта. Раньше на фуру уходили часы ручной сверки и переделки после таможни. ИИ и база проверенных кодов сверяют 50 000 посылок за минуты, считают пошлины и находят ошибки.',
  ...
  mk({
    ...
    metaDescription: 'Кейс X&X Dating — сервис знакомств внутри супер-аппа в Telegram Mini App: верификация по номеру, проверка родственных связей перед знакомством, единый вход со всеми сервисами X&X. Как устроено и кому подойдёт.',
  ...
  mk({
    ...
    metaDescription: 'Кейс X&X NEWS — новостной сервис внутри супер-аппа в Telegram Mini App: агрегация новостей из источников, лента плиткой, дайджест по подписке, единый вход с остальными сервисами X&X. Как устроено и кому подойдёт.',
  ...
  mk({
    ...
    metaDescription: 'Кейс X&X CINEMA — сервис онлайн-кинотеатра внутри супер-аппа в Telegram Mini App: каталог кино, продолжить просмотр, раздел «Моё», тарифы, единый вход с остальными сервисами X&X. Как устроено и кому подойдёт.',
  ...
  mk({
    ...
    metaDescription: 'Кейс X&X Market — маркетплейс объявлений и услуг мастеров внутри супер-аппа в Telegram Mini App: каталог, избранное, чаты, заявки мастерам, отметка «подтверждён сообществом», единый вход. Как устроено и кому подойдёт.',
