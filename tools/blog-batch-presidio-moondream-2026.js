...
module.exports = [
  mk({
    ...
    metaDescription: 'Открытый инструмент Microsoft Presidio находит в текстах и базах имена, телефоны, паспорта, карты и заменяет их — обезличивает данные.',
  ...
  mk({
    ...
    metaDescription: 'Moondream — крошечная открытая vision-модель: описывает фото, находит объекты, читает документы и отвечает на вопросы о картинке.',
