...
module.exports = [
  E({ slug: 'razrabotka-marketpleysa-pod-klyuch-2026', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Разработка маркетплейса под ключ: из чего складывается смета, какие модули нужны (каталог, продавцы, оплата, споры).',
  ...
  E({ slug: 'lichnyy-kabinet-dlya-klientov-2026', heroIcon: 'ph-fill ph-user-circle',
    ...
    metaDescription: 'Личный кабинет клиента на сайте: заказы, статусы, документы, оплата, поддержка. Зачем он бизнесу, как связать с CRM и сколько стоит разработка.',
  ...
  E({ slug: 'saas-ili-korobka-chto-vybrat-2026', heroIcon: 'ph-fill ph-scales',
    ...
    metaDescription: 'SaaS или коробка: где лежат данные, у кого контроль, что дешевле на старте и в долгую. Разбираю различия и подсказываю выбор под задачи бизнеса.',
  ...
  E({ slug: 'bot-vmesto-mobilnogo-prilozheniya-2026', heroIcon: 'ph-fill ph-robot',
    ...
    metaDescription: 'Бот вместо мобильного приложения: когда чат-бот или мини-приложение в мессенджере решает задачу дешевле и быстрее, чем нативное приложение.',
  ...
  E({ slug: 'telegram-mini-app-chto-eto-2026', heroIcon: 'ph-fill ph-app-window',
    ...
    metaDescription: 'Telegram Mini App простыми словами: что это, чем отличается от обычного бота и от сайта, что можно сделать (магазин, запись, оплата.',
  ...
  E({ slug: 'kak-zakazat-razrabotku-ne-poteryat-dengi-2026', heroIcon: 'ph-fill ph-shield-check',
    ...
    metaDescription: 'Как заказать разработку и не потерять деньги: на что смотреть в договоре, как фиксировать объём и сроки.',
  ...
  E({ slug: 'etapy-razrabotki-posle-predoplaty-2026', heroIcon: 'ph-fill ph-steps',
    ...
    metaDescription: 'Этапы разработки по шагам: что происходит после предоплаты — от ТЗ и прототипа до демо, тестирования, запуска и поддержки.',
  ...
  E({ slug: 'skolko-stoit-chas-razrabotki-2026', heroIcon: 'ph-fill ph-clock',
    ...
    metaTitle: 'Сколько стоит час разработки и почему дёшево выходит дорого',
    metaDescription: 'Сколько стоит час работы программиста, из чего складывается ставка и почему дешёвая разработка в итоге обходится дороже — разбор на практике.',
