...
module.exports = [
  E({ slug: 'samozanyatyy-ili-ip-2026', category: 'finance', heroIcon: 'ph-fill ph-scales',
    ...
    metaDescription: 'Самозанятый или ИП в 2026: чем отличаются по налогам, лимитам и работе с клиентами, что выбрать под свою ситуацию.',
  ...
  E({ slug: 'tilda-ili-wordpress-2026', category: 'development', heroIcon: 'ph-fill ph-browsers',
    ...
    metaDescription: 'Тильда или WordPress: чем отличаются по стоимости владения, скорости запуска, SEO и свободе доработок.',
  ...
  E({ slug: 'amocrm-ili-bitrix24-2026', category: 'development', heroIcon: 'ph-fill ph-address-book',
    ...
    metaDescription: 'amoCRM или Битрикс24: чем отличаются по логике работы, сложности внедрения, интеграциям и стоимости владения.',
  ...
  E({ slug: '1c-ili-bitrix24-2026', category: 'development', heroIcon: 'ph-fill ph-squares-four',
    ...
    metaDescription: '1С или Битрикс24: учёт и деньги против продаж и коммуникаций. Почему выбирать чаще всего не нужно, как связать системы и во сколько обойдётся владение.',
  ...
  E({ slug: 'ekvayring-ili-sbp-2026', category: 'finance', heroIcon: 'ph-fill ph-credit-card',
    ...
    metaDescription: 'Эквайринг или СБП: разница в комиссии, скорости зачисления и возвратах, что дешевле бизнесу и почему обычно выгоднее подключить оба способа.',
    ...
    readingMinutes: 15, shortForm: false, dateModified: '2026-08-09',
    toc: [
      { id: 'raznica', text: 'В чём разница' },
      { id: 'komissii', text: 'Диапазоны комиссий' },
      { id: 'sravnenie', text: 'Сравнение по критериям' },
      { id: 'skorost', text: 'Скорость зачисления' },
      { id: 'vozvraty', text: 'Возвраты и чарджбэки' },
      { id: 'kassa', text: 'Кассовый чек и 54-ФЗ' },
      { id: 'raschet', text: 'Расчёт экономии на обороте' },
      { id: 'ssylki', text: 'Платёжные ссылки' },
      { id: 'chto-vybrat', text: 'Что выбрать под свой бизнес' },
      { id: 'tretiy-put', text: 'Почему обычно нужны оба' },
  ...
  E({ slug: 'svoya-razrabotka-ili-gotovoe-tco-2026', category: 'development', heroIcon: 'ph-fill ph-calculator',
    ...
    metaDescription: 'Своя разработка или готовое решение: как считать полную стоимость владения за три года (лицензии, доработки, поддержка, миграция), а не цену покупки.',
