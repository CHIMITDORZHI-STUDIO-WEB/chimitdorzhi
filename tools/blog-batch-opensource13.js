...
module.exports = [
  E({ slug: 'open-loyalty-programma-loyalnosti-2026', heroIcon: 'ph-fill ph-medal',
    ...
    metaDescription: 'Open Loyalty — open-source платформа программы лояльности с геймификацией: баллы, уровни, награды, кэшбэк, челленджи, рефералы.',
  ...
  E({ slug: 'habitica-geymifikaciya-zadach-2026', heroIcon: 'ph-fill ph-sword',
    ...
    metaDescription: 'Habitica — open-source геймифицированный трекер задач и привычек (в стиле RPG): опыт, уровни, награды, гильдии, командные квесты.',
  ...
  E({ slug: 'classquiz-kviz-igry-2026', heroIcon: 'ph-fill ph-game-controller',
    ...
    metaDescription: 'ClassQuiz — open-source платформа квизов-игр в реальном времени (аналог Kahoot): участники отвечают с телефонов, рейтинг на экране.',
  ...
  E({ slug: 'gamification-engine-dvizhok-2026', heroIcon: 'ph-fill ph-trophy',
    ...
    metaDescription: 'Gamification Engine — open-source движок геймификации: баллы, бейджи, рейтинги, достижения, уровни, правила начисления.',
  ...
  E({ slug: 'badgr-cifrovye-beydzhi-2026', heroIcon: 'ph-fill ph-seal-check',
    ...
    metaDescription: 'Badgr Server (Open Badges) — open-source платформа выдачи цифровых бейджей и сертификатов за достижения: создание, выдача, проверка, коллекции.',
