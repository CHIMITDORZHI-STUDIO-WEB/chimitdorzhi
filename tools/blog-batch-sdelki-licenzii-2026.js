...
module.exports = [
  E({ slug: 'kupit-gotovyy-biznes-proverka-it-2026', category: 'development', heroIcon: 'ph-fill ph-magnifying-glass',
    ...
    metaDescription: 'Покупаете готовый бизнес — проверьте не только выручку: кому принадлежит домен и сайт, реальна ли база клиентов, где хостинг и доступы, нет ли рисков по 152-ФЗ. Чек-лист технической проверки.',
  ...
  E({ slug: 'licenziya-obrazovatelnaya-trebovaniya-k-saytu-2026', category: 'legal', heroIcon: 'ph-fill ph-graduation-cap',
    ...
    metaDescription: 'Лицензия на образовательную деятельность: какие требования предъявляют к сайту организации — раздел «Сведения об образовательной организации», обязательные документы, доступность и 152-ФЗ.',
  ...
  E({ slug: 'akkreditaciya-it-kompanii-2026', category: 'legal', heroIcon: 'ph-fill ph-certificate',
    ...
    metaDescription: 'Аккредитация IT-компании: какие льготы даёт (налоги, страховые взносы, отсрочка для сотрудников), кто может получить, какие требования к выручке и ОКВЭД и как проходит процедура.',
  ...
  E({ slug: 'elektronnyy-katalog-biblioteki-2026', category: 'industries', heroIcon: 'ph-fill ph-books',
    ...
    metaDescription: 'Электронный каталог библиотеки: как перевести фонд в цифру, что должно быть в каталоге (поиск, выдача, читательский билет), какие есть готовые системы и когда нужна своя разработка.',
  ...
  E({ slug: 'ocenka-i-prodazha-biznesa-cifrovye-aktivy-2026', category: 'finance', heroIcon: 'ph-fill ph-chart-line-up',
    ...
    metaDescription: 'Оценка бизнеса перед продажей: как считать стоимость цифровых активов — сайта, базы клиентов, домена, соцсетей, автоматизации — и как упаковать бизнес, чтобы он стоил дороже.',
  ...
  E({ slug: 'cifrovoe-nasledstvo-biznesa-2026', category: 'development', heroIcon: 'ph-fill ph-key',
    ...
    metaDescription: 'Что будет с сайтом, доменом, почтой и базой, если ключевой человек уйдёт: как навести порядок в доступах, оформить их на компанию, подготовить передачу и что делать при ликвидации.',
  ...
  E({ slug: 'trebovaniya-k-saytu-shkoly-2026', category: 'legal', heroIcon: 'ph-fill ph-student',
    ...
    metaDescription: 'Требования к сайту школы, детского сада и бюджетного учреждения: обязательный раздел со сведениями, перечень документов, версия для слабовидящих, хостинг в РФ и 152-ФЗ. Чек-лист проверки.',
  ...
  E({ slug: 'programma-semeynoe-drevo-2026', category: 'industries', heroIcon: 'ph-fill ph-tree-structure',
    ...
    metaDescription: 'Как составить родословную онлайн и сохранить семейный архив: какие программы для семейного древа есть, чем отличаются, как оцифровать старые фото и документы и где всё это хранить надёжно.',
