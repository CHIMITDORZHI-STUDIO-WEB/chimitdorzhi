...
module.exports = [
  ...
  E({
    ...
    metaDescription: 'Закрытый клуб по подписке: как запустить эксперту — модели монетизации, на чём собрать (Telegram, MAX, платформа) и удержать людей — внедряю под ключ.',
