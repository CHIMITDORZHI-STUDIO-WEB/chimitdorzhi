...
module.exports = [
  E({
    ...
    metaDescription: 'Как частному психологу соблюдать 152-ФЗ: согласие на обработку, особая категория данных о здоровье, безопасное хранение записей сессий.',
  ...
  E({
    ...
    metaDescription: 'Куда переводить аудиторию психологу, коучу и эзотерику после блокировки соцсетей: Telegram, MAX, VK и свой сайт, своя база вместо чужой ленты.',
  ...
  E({
    ...
    metaDescription: 'Как настроить онлайн-запись психологу и коучу: убрать ручную переписку о слотах, напоминания против неявок (no-show), предоплата как фильтр, инструменты.',
  ...
  E({
    ...
    metaDescription: 'Как тарологу, астрологу и нумерологу собрать чат-бот: приём заявок и оплаты без переписки, AI-расклады и гороскопы как контент и вовлечение.',
  ...
  E({
    ...
    metaDescription: 'Как частному практику принимать оплату: СБП, карты и ссылки на оплату, пакеты сессий и предоплата, самозанятость и чеки по 54-ФЗ.',
  ...
  E({
    ...
    metaDescription: 'Зачем частному практику CRM: единая база клиентов и история сессий, напоминания и повторные записи, конфиденциальность по 152-ФЗ.',
  ...
  E({
    ...
    metaDescription: 'Как эксперту запустить закрытый клуб по подписке: модели монетизации (подписка, уровни, разовый доступ), на чём собрать (Telegram, MAX, своя платформа).',
  ...
  E({
    ...
    metaDescription: 'Зачем психологу и коучу свой сайт, если есть соцсети: структура продающей страницы эксперта, запись и заявки прямо с сайта, доверие через отзывы.',
