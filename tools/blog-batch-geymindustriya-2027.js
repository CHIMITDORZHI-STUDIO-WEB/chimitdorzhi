...
module.exports = [
  E({ slug: 'biznes-privatnyy-server-gta-cs-minecraft-2027', heroIcon: 'ph-fill ph-server',
    ...
    metaDescription: 'Разбираю бизнес-модель приватных серверов GTA (FiveM/RP), CS2 и Minecraft: как устроена монетизация через донат.',
  ...
  E({ slug: 'hosting-igrovyh-serverov-saas-2027', heroIcon: 'ph-fill ph-cloud',
    ...
    metaDescription: 'Разбираю бизнес-модель game server hosting: как устроена подписочная аренда игровых серверов «в один клик» на базе панелей вроде Pterodactyl.',
  ...
  E({ slug: 'ekonomika-mobilnoy-f2p-igry-2027', heroIcon: 'ph-fill ph-chart-line-up',
    ...
    metaDescription: 'Объясняю ключевые метрики экономики бесплатных мобильных игр простым языком: что такое LTV, ARPU и ARPPU.',
  ...
  E({ slug: 'user-acquisition-mobilnyh-igr-2027', heroIcon: 'ph-fill ph-target',
    ...
    metaDescription: 'Разбираю платное привлечение пользователей (UA) в мобильных играх: каналы привлечения, что такое CAC.',
  ...
  E({ slug: 'marketplace-skinov-steam-cs2-2027', heroIcon: 'ph-fill ph-shopping-bag',
    ...
    metaDescription: 'Разбираю бизнес-модель торговли игровыми предметами: как устроен официальный Steam Community Market, зачем нужны сторонние маркетплейсы скинов.',
  ...
  E({ slug: 'bust-akkauntov-reytinga-2027', heroIcon: 'ph-fill ph-trophy',
    ...
    metaDescription: 'Буст рейтинга в League of Legends, Dota 2 и CS2: как устроен рынок услуг, кто их покупает, почему разработчики банят и где проходит серая зона.',
  ...
  E({ slug: 'prodazha-peredacha-igrovyh-akkauntov-2027', heroIcon: 'ph-fill ph-user-switch',
    ...
    metaDescription: 'Разбираю рынок купли-продажи готовых игровых аккаунтов: почему это формально нарушает пользовательские соглашения игр.',
