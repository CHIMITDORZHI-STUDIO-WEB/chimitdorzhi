...
module.exports = [
  E({ slug: 'sayt-katalog-proizvoditelya-oborudovaniya-2027', heroIcon: 'ph-fill ph-factory', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Как сделать сайт-каталог для производителя оборудования: карточки с техническими характеристиками, фильтр по параметрам.',
  ...
  E({ slug: 'avtomatizaciya-seti-magazinov-2027', heroIcon: 'ph-fill ph-buildings', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Как автоматизировать сеть из нескольких точек: единая база остатков, клиентов и выручки вместо разрозненных Excel-таблиц по каждому магазину.',
