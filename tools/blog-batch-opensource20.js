...
module.exports = [
  E({ slug: 'stalwart-pochtovyy-server-2026', heroIcon: 'ph-fill ph-envelope-simple',
    ...
    metaDescription: 'Stalwart Mail — почтовый сервер всё-в-одном (SMTP, IMAP, JMAP) на своём домене: антиспам, шифрование, веб-админка и никакой платы за ящик.',
  ...
  E({ slug: 'qloapps-bronirovanie-oteley-2026', heroIcon: 'ph-fill ph-bed',
    ...
    metaDescription: 'QloApps — open-source система бронирования и управления для отелей: номера и тарифы, календарь занятости, онлайн-бронирование с сайта, приём оплаты.',
  ...
  E({ slug: 'esphome-zigbee-datchiki-2026', heroIcon: 'ph-fill ph-thermometer',
    ...
    metaDescription: 'ESPHome и Zigbee2MQTT — open-source основа умного здания без вендора и облака: свои датчики температуры, протечки, открытия дверей.',
  ...
  E({ slug: 'h5p-interaktivnye-uroki-2026', heroIcon: 'ph-fill ph-puzzle-piece',
    ...
    metaDescription: 'H5P — open-source конструктор интерактивного контента: интерактивные видео с вопросами, тесты, флешкарты, перетаскивания, ветвящиеся сценарии, тренажёры.',
  ...
  E({ slug: 'dawarich-istoriya-peremeshcheniy-2026', heroIcon: 'ph-fill ph-map-pin-area',
    ...
    metaDescription: 'Dawarich — open-source хранилище истории перемещений (приватная альтернатива Google Timeline): геотреки со смартфона, карта, статистика, посещённые места.',
