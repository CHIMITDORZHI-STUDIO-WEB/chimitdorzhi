...
module.exports = [
  {
    ...
    metaDescription: 'Как ИИ-редактор строит 3D-комнату по описанию или фото и помогает мебельному салону и дизайнеру продавать: клиент видит свой интерьер до покупки.',
