...
module.exports = [
  mk({
    ...
    metaDescription: 'Кейс АвтоМост — витрина автомобилей с китайских площадок: каталог подгружается через API, фильтры по марке и цене, расчёт итоговой стоимости с таможней и доставкой, кеширование фото на своём домене. Как устроено и кому подойдёт.',
  ...
  mk({
    ...
    metaDescription: 'Кейс One Click — двуязычная справка (испанский/английский) для платформы QR/NFC-страниц с собственной CMS: заказчик сам редактирует инструкцию блоками, встроен ИИ-перевод ES→EN, тёмная тема, отдаётся под one-click.app/help. Как устроено.',
  ...
  mk({
    ...
    metaDescription: 'Кейс: посадочная под рекламу в Яндекс.Директе для услуги аудита 152-ФЗ. Моно-фокус на одном действии, калькулятор риска штрафа, форма заявки прямо в Telegram-бота, цели Яндекс.Метрики под каждое обращение. Как устроено и кому подойдёт.',
