...
module.exports = [
  {
    ...
    metaTitle: 'Корпоративный AI-ассистент на своих данных: приватный RAG без утечек',
  ...
  },
  {
    ...
    metaTitle: 'AI-видеоаватары для контента, обучения и поддержки: где реально окупается',
