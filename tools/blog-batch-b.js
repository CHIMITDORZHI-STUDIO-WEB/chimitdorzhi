...
module.exports = [
  {
    ...
    metaDescription: 'Как построить корпоративный AI-ассистент на своих данных: приватный RAG-контур без утечек, российский AI-стек GigaChat и YandexGPT.',
  ...
  },
  {
    ...
    metaDescription: 'AI-видеоаватары для контента, обучения сотрудников и видеоподдержки: как создаётся цифровая копия, где технология окупается.',
  ...
  },
  {
    ...
    metaDescription: 'Чем отличаются fine-tuning, RAG и вызов модели через API, когда что выбирать бизнесу, как считать бюджет и учитывать 152-ФЗ.',
  ...
  },
  {
    ...
    metaDescription: 'GEO для российского нейропоиска: как структурировать контент под цитирование Алисой, GigaChat и нейроответами.',
