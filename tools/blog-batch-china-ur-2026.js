...
module.exports = [
  ...
  E({ slug: 'zakaz-s-1688-napryamuyu-2026', category: 'industries', heroIcon: 'ph-fill ph-package',
    ...
    metaDescription: 'Как заказывать на 1688 напрямую из Китая: как устроена площадка, как найти поставщика, оплатить и получить товар через посредника-выкупщика.',
  ...
  E({ slug: 'kargo-dostavka-iz-kitaya-2026', category: 'industries', heroIcon: 'ph-fill ph-truck',
    ...
    metaDescription: 'Карго-доставка из Китая простыми словами: чем серая логистика отличается от белого импорта, риски потери и конфискации, когда что выбрать.',
  ...
  E({ slug: 'priem-oplaty-na-sayt-yukassa-2026', category: 'development', heroIcon: 'ph-fill ph-credit-card',
    ...
    metaDescription: 'Приём оплаты на сайте: как устроена ЮKassa, чем отличаются СБП, Т-Касса и ЮMoney, что нужно для подключения и как встроить оплату под ключ.',
  ...
  E({ slug: 'neyroset-dlya-video-2026', category: 'ai-life', heroIcon: 'ph-fill ph-film-strip',
    ...
    metaDescription: 'Нейросети для видео в 2026: что они умеют (генерация роликов, аватары, озвучка, монтаж), какие типы инструментов бывают.',
  ...
  E({ slug: 'ocr-raspoznat-tekst-s-foto-2026', category: 'ai-life', heroIcon: 'ph-fill ph-scan',
    ...
    metaDescription: 'Как вытащить текст из фото, скана и PDF: чем распознавать, насколько точно выходит с русским и рукописью и как автоматизировать ввод документов.',
  ...
  E({ slug: 'vypiska-iz-egryul-besplatno-2026', category: 'legal', heroIcon: 'ph-fill ph-file-magnifying-glass',
    ...
    metaDescription: 'Как получить выписку из ЕГРЮЛ или ЕГРИП бесплатно за пару минут: где заказать электронную выписку с подписью ФНС.',
  ...
  E({ slug: 'patent-ili-usn-dlya-ip-2026', category: 'finance', heroIcon: 'ph-fill ph-scales',
    ...
    metaDescription: 'Патент (ПСН) или УСН для ИП в 2026: чем отличаются, кому что выгоднее, как прикинуть налог на своём обороте и можно ли совмещать.',
