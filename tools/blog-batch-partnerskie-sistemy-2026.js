...
module.exports = [
  ...
  E({ slug: 'lichnyy-kabinet-partnera-2026', category: 'development', heroIcon: 'ph-fill ph-users-three',
    ...
    metaDescription: 'Личный кабинет партнёра: какие разделы нужны (статистика, рефссылки, выплаты, материалы, обучение), как считать вознаграждения, что взять готовое и когда нужна своя система.',
  ...
  E({ slug: 'uchet-partnerskih-vyplat-2026', category: 'development', heroIcon: 'ph-fill ph-coins',
    ...
    metaDescription: 'Как технически устроен учёт партнёрских выплат: отслеживание рефссылок и промокодов, атрибуция продаж, расчёт начислений, холд и выплаты. Что автоматизировать и где чаще всего ошибаются.',
  ...
  E({ slug: 'kak-nayti-dilerov-i-postroit-set-2026', category: 'sales', heroIcon: 'ph-fill ph-handshake',
    ...
    metaDescription: 'Как найти дилеров и региональных представителей: где искать, что предложить, как выстроить систему работы с сетью, контролировать цены и не потерять управляемость при росте.',
  ...
  E({ slug: 'kak-otkryt-svoyu-franshizu-2026', category: 'sales', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Как упаковать бизнес во франшизу: готов ли бизнес к масштабированию, что входит в упаковку (стандарты, обучение, договор, финмодель), сколько это стоит и с чего начать запуск.',
  ...
  E({ slug: 'paushalnyy-vznos-i-royalti-2026', category: 'finance', heroIcon: 'ph-fill ph-calculator',
    ...
    metaDescription: 'Паушальный взнос и роялти простыми словами: чем отличаются, из чего складываются, какие бывают схемы роялти (процент, фикс, комбинированные) и как их считать со стороны франчайзера и покупателя.',
  ...
  E({ slug: 'it-platforma-dlya-franshizy-2026', category: 'development', heroIcon: 'ph-fill ph-buildings',
    ...
    metaDescription: 'IT-платформа для франшизы: как управлять сетью точек из одной системы — отчётность франчайзи, контроль стандартов, расчёт роялти, обучение, единый бренд и данные. Что входит и сколько стоит.',
  ...
  E({ slug: 'agentskiy-dogovor-i-voznagrazhdenie-2026', category: 'legal', heroIcon: 'ph-fill ph-file-text',
    ...
    metaDescription: 'Агентский договор простыми словами: чем отличается от подряда и поставки, что обязательно прописать, как считается и подтверждается агентское вознаграждение и зачем нужен отчёт агента.',
  ...
  E({ slug: 'geymifikaciya-partnerov-2026', category: 'sales', heroIcon: 'ph-fill ph-trophy',
    ...
    metaDescription: 'Как мотивировать партнёров и менеджеров без бесконечных скидок: рабочие механики конкурсов, рейтинги без демотивации, баллы и статусы вместо скидок, прозрачный зачёт результатов.',
