...
module.exports = [
  E({ slug: 'cfa-vs-kriptovalyuta-biznes-rf-2027', category: 'finance',
    ...
    metaDescription: 'Чем цифровые финансовые активы (ЦФА) отличаются от криптовалюты, что легально для бизнеса в России.',
  ...
  E({ slug: 'cifrovoy-rubl-dlya-biznesa-tehnicheski-2027', category: 'finance',
    ...
    metaDescription: 'Цифровой рубль простыми словами: чем он отличается от безнала и криптовалюты, как устроен технически, что меняется для бизнеса в расчётах и кассах.',
  ...
  E({ slug: 'aml-kyc-avtomatizaciya-proverki-klientov-2027', category: 'security',
    ...
    metaDescription: 'AML и KYC простыми словами: зачем бизнесу проверять клиентов, как устроена проверка (идентификация, санкционные и другие списки, оценка риска).',
  ...
  E({ slug: 'web3-defi-dao-prostymi-slovami-2027', category: 'expert',
    ...
    metaDescription: 'Web3, DeFi и DAO простыми словами: что это за технологии, как устроены блокчейн, смарт-контракты и децентрализованные приложения.',
  ...
  E({ slug: 'regulirovanie-cifrovyh-aktivov-mira-2027', category: 'expert',
    ...
    metaDescription: 'Образовательный обзор подходов к регулированию цифровых активов в мире: MiCA в Евросоюзе, VARA в ОАЭ, MAS в Сингапуре — общими словами.',
