...
module.exports = [
  mk({
    ...
    metaDescription: 'ERPNext — открытая ERP: учёт, склад, продажи, закупки, производство и HR в одном месте, на своём сервере и без лицензий на пользователя.',
  ...
  mk({
    ...
    metaDescription: 'Directus делает из SQL-базы удобную админку и готовый API за минуты: контент, данные, интеграции для сайта. Кому подходит headless-подход.',
  ...
  mk({
    ...
    metaDescription: 'Snipe-IT — открытый учёт оргтехники: у кого какой ноутбук, где что стоит, когда кончается гарантия, история устройств. Свой сервер, без лицензий.',
  ...
  mk({
    ...
    metaDescription: 'Portainer позволяет управлять Docker без командной строки: запуск и обновление контейнеров, логи, мониторинг. Кому это упрощает жизнь и как поставить.',
  ...
  mk({
    ...
    metaDescription: 'Airbyte собирает данные из разных систем — CRM, магазин, база, сервисы — в одно место для отчётов и аналитики.',
  ...
  mk({
    ...
    metaDescription: 'Strapi — открытая headless CMS: один контент-бэкенд с API сразу для сайта и мобильного приложения. Чем отличается от обычной CMS и как внедрить.',
