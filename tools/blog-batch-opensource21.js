...
module.exports = [
  E({ slug: 'live-commerce-svoya-ploschadka-opensource-2026', heroIcon: 'ph-fill ph-broadcast',
    ...
    metaDescription: 'Из чего собрать свою площадку live-commerce (продажи в прямом эфире) на open-source: низколатентный стрим (LiveKit, SRS, Owncast).',
  ...
  E({ slug: 'livekit-interaktivnye-translyacii-2026', heroIcon: 'ph-fill ph-video-conference',
    ...
    metaDescription: 'LiveKit — open-source WebRTC-платформа для real-time трансляций с суб-секундной задержкой: комнаты, запись, ingress/egress.',
  ...
  E({ slug: 'srs-strim-server-2026', heroIcon: 'ph-fill ph-broadcast',
    ...
    metaDescription: 'SRS (Simple Realtime Server) — мощный open-source стриминг-сервер (RTMP, WebRTC, HLS, SRT, кластеризация, низкая задержка).',
  ...
  E({ slug: 'restreamer-multistream-2026', heroIcon: 'ph-fill ph-share-network',
    ...
    metaDescription: 'Restreamer (datarhei) — open-source приём одного потока и одновременная ретрансляция в VK Видео, Telegram, YouTube и на свой сайт, плюс плеер и запись.',
  ...
  E({ slug: 'vendure-headless-magazin-2026', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Vendure — современный open-source headless commerce (Node/TypeScript, GraphQL): товары, заказы, оплата, скидки, плагины, админка.',
