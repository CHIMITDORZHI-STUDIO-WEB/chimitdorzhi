...
module.exports = [
  {
    ...
    metaDescription: 'Что такое перехват мобильной связи, по каким признакам его можно заподозрить и как защитить важные переговоры: защищённые мессенджеры, шифрование, организационные меры. Со стороны защиты.',
