...
module.exports = [
  E({ slug: 'kak-sdelat-platezhnogo-bota-v-max-2027', category: 'development',
    ...
    metaDescription: 'Платёжный бот в MAX: что умеют бот и Mini App, как устроен приём оплаты, требования к верификации юрлица и API. Опыт того, кто это уже собрал.',
  ...
  E({ slug: 'referalnaya-mehanika-v-max-keys-2027', category: 'development',
    ...
    metaDescription: 'Как устроена реферальная кампания «приведи друга» в мессенджере MAX: deep links с payload, отслеживание приглашений, проверка подписки на канал.',
  ...
  E({ slug: '54-fz-dlya-platezhey-samozanyatyy-ip-ooo-2027', category: 'finance',
    ...
    metaDescription: '54-ФЗ при приёме онлайн-оплаты: когда нужна онлайн-касса, чем отличаются сценарии для самозанятого, ИП и ООО.',
  ...
  E({ slug: 'fiksirovannaya-cena-vs-pochasovka-2027', category: 'expert',
    ...
    metaDescription: 'Фиксированная цена, почасовая оплата или поэтапная оплата за разработку сайта, бота или автоматизации: чем модели отличаются, где риски для заказчика.',
