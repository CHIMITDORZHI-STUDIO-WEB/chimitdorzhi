...
module.exports = [
  E({ slug: 'mixpost-smm-tsentr-2026', heroIcon: 'ph-fill ph-megaphone',
    ...
    metaDescription: 'Mixpost — open-source платформа планирования и автопостинга во все соцсети (аналог Buffer/Hootsuite): единый календарь, очередь, командная работа.',
  ...
  E({ slug: 'discourse-soobschestvo-forum-2026', heroIcon: 'ph-fill ph-users-three',
    ...
    metaDescription: 'Discourse — ведущая open-source платформа онлайн-сообществ и форумов: темы, обсуждения, репутация, модерация, уведомления, единый вход.',
  ...
  E({ slug: 'remotion-video-iz-shablonov-2026', heroIcon: 'ph-fill ph-film-strip',
    ...
    metaDescription: 'Remotion — open-source фреймворк для создания видео кодом: один шаблон плюс данные из таблицы дают десятки роликов автоматически.',
  ...
  E({ slug: 'excalidraw-infografika-karuseli-2026', heroIcon: 'ph-fill ph-pen-nib',
    ...
    metaDescription: 'Excalidraw — open-source редактор схем, инфографики и каруселей: командная работа в реальном времени, фирменные шаблоны, экспорт в PNG/SVG.',
