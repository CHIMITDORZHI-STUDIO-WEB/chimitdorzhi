...
module.exports = [
  ...
  E({ slug: 'elektronnye-trudovye-knizhki-2026', category: 'legal', heroIcon: 'ph-fill ph-identification-badge',
    ...
    metaDescription: 'Электронные трудовые книжки (ЭТК): что обязан работодатель, как подавать сведения (ЕФС-1), сроки.',
  ...
  E({ slug: 'ohrana-truda-dokumenty-2026', category: 'legal', heroIcon: 'ph-fill ph-hard-hat',
    ...
    metaDescription: 'Охрана труда в малом бизнесе: какие документы обязательны для ИП и ООО с сотрудниками, инструктажи, СОУТ и оценка рисков, штрафы за их отсутствие.',
  ...
  E({ slug: 'sayt-dlya-fotografa-2026', category: 'development', heroIcon: 'ph-fill ph-camera',
    ...
    metaDescription: 'Сайт для фотографа: что должно быть на сайте-портфолио, чтобы он приносил заказы (галереи, цены, отзывы, запись).',
  ...
  E({ slug: 'sayt-dlya-vracha-2026', category: 'development', heroIcon: 'ph-fill ph-first-aid',
    ...
    metaDescription: 'Сайт для врача или частного специалиста: что должно быть (услуги, запись, отзывы, документы).',
  ...
  E({ slug: 'vsplyvayushchee-okno-na-sayte-2026', category: 'marketing', heroIcon: 'ph-fill ph-cursor-click',
    ...
    metaDescription: 'Всплывающие окна (поп-апы) на сайте: когда они поднимают заявки, а когда только раздражают и роняют конверсию.',
  ...
  E({ slug: 'udalit-otzyv-s-yandex-kart-2026', category: 'marketing', heroIcon: 'ph-fill ph-star-half',
    ...
    metaDescription: 'Как удалить негативный отзыв с Яндекс.Карт: какие отзывы снимаются по правилам, как подать жалобу и что делать с необоснованным негативом.',
