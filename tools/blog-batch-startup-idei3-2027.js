...
module.exports = [
  E({ slug: 'obmen-prisotrom-dom-pitomec-po-chlenstvu-2027', heroIcon: 'ph-fill ph-house-line',
    ...
    metaTitle: 'Обмен присмотром за домом и питомцем (аналог TrustedHousesitters)',
  ...
  E({ slug: 'verifikaciya-gostey-kratkosrochnoy-arendy-2027', heroIcon: 'ph-fill ph-shield-check',
    ...
    metaTitle: 'Верификация гостей краткосрочной аренды (аналог Autohost/Superhog)',
  ...
  E({ slug: 'generator-yuridicheskih-dokumentov-onlayn-2027', heroIcon: 'ph-fill ph-file-text',
    ...
    metaTitle: 'Генератор юридических документов онлайн (аналог Rocket Lawyer)',
  ...
  E({ slug: 'dostup-k-zarplate-do-dnya-vyplaty-2027', heroIcon: 'ph-fill ph-wallet',
    ...
    metaTitle: 'Досрочный доступ к заработанной зарплате (аналог DailyPay/Even)',
    metaDescription: 'Разбираю модель зарубежных сервисов DailyPay и Even: сотрудник может получить часть уже отработанной, но ещё не выплаченной зарплаты раньше официальной даты, без займов и процентов ростовщика. Как такая модель могла бы работать в России и какие трудовые и финансовые вопросы она поднимает. Образовательный материал, не финансовая и не юридическая консультация.',
