...
module.exports = [
  E({ slug: 'obmen-prisotrom-dom-pitomec-po-chlenstvu-2027', heroIcon: 'ph-fill ph-house-line',
    ...
    metaTitle: 'Обмен присмотром за домом и питомцами',
    metaDescription: 'TrustedHousesitters: путешественник бесплатно живёт в доме и присматривает за питомцем, пока хозяева в отпуске. Почему такой модели нет в России.',
  ...
  E({ slug: 'personalnyy-shopper-dostavka-produktov-2027', heroIcon: 'ph-fill ph-shopping-cart',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Instacart: не даркстор, а реальный шоппер, который сам ходит по полкам обычного супермаркета.',
  ...
  E({ slug: 'verifikaciya-gostey-kratkosrochnoy-arendy-2027', heroIcon: 'ph-fill ph-shield-check',
    ...
    metaDescription: 'Разбираю модель зарубежных сервисов Autohost и Superhog: B2B-платформа для владельцев квартир посуточной аренды.',
  ...
  E({ slug: 'generator-yuridicheskih-dokumentov-onlayn-2027', heroIcon: 'ph-fill ph-file-text',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Rocket Lawyer: онлайн-платформа, где по нескольким вопросам собирается типовой юридический документ — договор.',
  ...
  E({ slug: 'iot-platforma-dlya-arendodateley-2027', heroIcon: 'ph-fill ph-buildings',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса SmartRent: единая платформа для управляющих компаний и арендодателей многоквартирных домов.',
  ...
  E({ slug: 'dostup-k-zarplate-do-dnya-vyplaty-2027', heroIcon: 'ph-fill ph-wallet',
    ...
    metaDescription: 'Зарплата до дня выплаты: как устроены DailyPay и Even — сотрудник берёт часть отработанного без займов и процентов. Применимость модели в России.',
