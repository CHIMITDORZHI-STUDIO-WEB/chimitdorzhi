...
module.exports = [
  E({ slug: 'stirling-pdf-instrumenty-2026', heroIcon: 'ph-fill ph-file-pdf',
    ...
    metaDescription: 'Stirling-PDF — open-source набор из 50+ инструментов для PDF через веб: объединение, разделение, сжатие, OCR, водяные знаки, конвертация.',
  ...
  E({ slug: 'formbricks-formy-oprosy-2026', heroIcon: 'ph-fill ph-list-checks',
    ...
    metaDescription: 'Formbricks — open-source инструмент для форм, опросов и анкет (аналог Typeform/Google Forms): ветвление, файловые загрузки, вебхуки, опросы на сайте.',
  ...
  E({ slug: 'home-assistant-umnyy-ofis-2026', heroIcon: 'ph-fill ph-house-line',
    ...
    metaDescription: 'Home Assistant — open-source система автоматизации (умный дом/офис/здание): объединяет свет, климат, камеры, датчики и доступ, сценарии.',
  ...
  E({ slug: 'adguard-home-zaschita-seti-2026', heroIcon: 'ph-fill ph-shield-checkered',
    ...
    metaDescription: 'AdGuard Home — open-source DNS-сервер с блокировкой рекламы, трекеров и вредоносных сайтов на уровне всей сети.',
