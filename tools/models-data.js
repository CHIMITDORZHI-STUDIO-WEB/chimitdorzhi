...
const BASE = [
  {
    ...
    license: 'Apache 2.0 (большинство версий); у старших Qwen3.8 — своя лицензия', commercial: 'conditional', hardware: ['min', 'gpu', 'multi'],
  ...
  },
  {
    ...
    license: 'Llama Community License', commercial: 'conditional', hardware: ['min', 'gpu', 'multi'],
  ...
  },
  {
    ...
    license: 'MIT', commercial: 'yes', hardware: ['gpu', 'multi'],
  ...
  },
  {
    ...
    license: 'Apache 2.0', commercial: 'yes', hardware: ['gpu'],
  ...
  },
  {
    ...
    license: 'Gemma 4 — Apache 2.0; ранние версии — Gemma Terms of Use', commercial: 'yes', hardware: ['min', 'gpu'],
  ...
  },
  {
    ...
    license: 'Apache 2.0 (большинство версий)', commercial: 'yes', hardware: ['min', 'gpu', 'multi'],
  ...
  },
  {
    ...
    license: 'MIT', commercial: 'yes', hardware: ['min', 'gpu'],
  ...
  },
  {
    ...
    license: 'FLUX.1 [schnell] и FLUX.2 [klein] 4B — Apache 2.0; версии [dev] — некоммерческие', commercial: 'conditional', hardware: ['gpu'],
  ...
  },
  {
    ...
    license: 'До Qwen-Image-2512 — Apache 2.0; Qwen-Image-2.1 — исследовательская, некоммерческая', commercial: 'conditional', hardware: ['gpu'],
  ...
  },
  {
    ...
    license: 'Apache 2.0', commercial: 'yes', hardware: ['gpu', 'multi'],
  ...
  },
  {
    ...
    license: 'MIT', commercial: 'yes', hardware: ['min'],
  ...
  },
  {
    ...
    license: 'SAM и SAM 2 — Apache 2.0; SAM 3 — SAM License (коммерция разрешена)', commercial: 'conditional', hardware: ['min', 'gpu'],
