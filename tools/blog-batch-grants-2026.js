...
module.exports = [
  E({ slug: 'grant-na-ii-proekt-razvitie-ii-2026', heroIcon: 'ph-fill ph-brain', ctaInternal: AGENTS,
    ...
    metaDescription: 'Грант на ИИ-проект по конкурсу «Развитие-Искусственный интеллект» Фонда содействия инновациям: условия, кто может подать и какие расходы покрывает.',
  ...
  E({ slug: 'podderzhka-kreativnyh-industriy-dfo-2026', heroIcon: 'ph-fill ph-palette', ctaInternal: PRED,
    ...
    metaDescription: 'Меры поддержки креативных индустрий Дальнего Востока в 2026: гранты и программы (например, «Креативный код.',
  ...
  E({ slug: 'granty-na-vnutrenniy-turizm-rgo-2026', heroIcon: 'ph-fill ph-mountains', ctaInternal: PRED,
    ...
    metaDescription: 'Гранты Русского географического общества на внутренний туризм, краеведение и сохранение живой природы.',
  ...
  E({ slug: 'kredity-i-lgoty-dlya-biznesa-2026', heroIcon: 'ph-fill ph-bank', ctaInternal: ANALYTICS,
    ...
    metaDescription: 'Навигатор по мерам поддержки бизнеса в 2026: гранты и конкурсы (ИИ, туризм, креативные индустрии), льготные кредиты для МСП и социальных предпринимателей.',
