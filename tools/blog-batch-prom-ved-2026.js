...
module.exports = [
  ...
  E({ slug: 'chertezhi-onlayn-dwg-pdf-2026', category: 'industries', heroIcon: 'ph-fill ph-ruler',
    ...
    metaDescription: 'Чертежи онлайн: как открыть и посмотреть DWG, DXF и PDF без AutoCAD, чем измерять и конвертировать.',
  ...
  E({ slug: 'mes-sistema-dlya-proizvodstva-2026', category: 'industries', heroIcon: 'ph-fill ph-factory',
    ...
    metaDescription: 'MES-система простыми словами: чем отличается от ERP и 1С, что автоматизирует на производстве — план, наряды, склад, ОТК — и когда нужна своя.',
  ...
  E({ slug: 'platezhi-iz-za-rubezha-2026', category: 'industries', heroIcon: 'ph-fill ph-currency-circle-dollar',
    ...
    metaDescription: 'Как получать платежи из-за рубежа в 2026: какие способы работают (платёжные агенты, валютный счёт, крипта у некоторых), комиссии и сроки.',
  ...
  E({ slug: 'eksport-tovarov-iz-rossii-msb-2026', category: 'industries', heroIcon: 'ph-fill ph-package',
    ...
    metaDescription: 'Экспорт товаров из России для малого бизнеса: с чего начать, как найти покупателя за рубежом, оформить документы и получить оплату.',
  ...
  E({ slug: 'samozanyatyy-priem-oplaty-legalno-2026', category: 'finance', heroIcon: 'ph-fill ph-receipt',
    ...
    metaDescription: 'Как самозанятому принимать оплату легально в 2026: какие способы можно (карта, СБП, ссылка на оплату), как формировать чеки в «Мой налог».',
  ...
  E({ slug: 'crm-dlya-optovyh-prodazh-2026', category: 'development', heroIcon: 'ph-fill ph-address-book',
    ...
    metaDescription: 'CRM для оптовых продаж: чем опт отличается от розницы, что должна уметь система (дилеры, персональные прайсы, повторные заказы, дебиторка).',
  ...
  E({ slug: 'fulfilment-dlya-marketpleysov-2026', category: 'industries', heroIcon: 'ph-fill ph-package',
    ...
    metaDescription: 'Фулфилмент для маркетплейсов простыми словами: разница FBO и FBS, что делает оператор, из чего складывается цена и как автоматизировать учёт.',
  ...
  E({ slug: 'chaevye-po-qr-kodu-2026', category: 'industries', heroIcon: 'ph-fill ph-qr-code',
    ...
    tags: ['чаевые', 'QR', 'HoReCa', 'платежи', 'салоны красоты'],
    toc: [
      { id: 'kak-rabotaet', text: 'Как это работает' },
      { id: 'komu-nuzhno', text: 'Кому это реально нужно' },
      { id: 'servisy', text: 'Сервисы чаевых: сравнение' },
      { id: 'podklyuchenie', text: 'Как подключить: пошагово' },
      { id: 'nalogi', text: 'Налоги и самозанятость' },
      { id: 'tablichka', text: 'QR-табличка на стол' },
      { id: 'raspredelenie', text: 'Распределение между сотрудниками' },
      { id: 'oshibki', text: 'Частые ошибки при внедрении' },
      { id: 'svoy', text: 'Свой сервис чаевых или готовый' },
