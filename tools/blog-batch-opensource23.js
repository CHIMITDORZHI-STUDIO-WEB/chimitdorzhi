...
module.exports = [
  E({ slug: 'phaser-promo-igry-dlya-biznesa-2026', heroIcon: 'ph-fill ph-game-controller',
    ...
    metaDescription: 'Phaser — open-source движок HTML5-игр для бизнеса: колесо фортуны, аркада за приз, мини-квиз в сайт, лендинг и бот.',
  ...
  E({ slug: 'gdevelop-promo-igry-bez-koda-2026', heroIcon: 'ph-fill ph-cursor-click',
    ...
    metaDescription: 'GDevelop — open-source конструктор игр без кода: быстрые промо-игры под маркетинговые акции (колесо фортуны, аркады, квизы) с экспортом в web и мобайл.',
  ...
  E({ slug: 'pixijs-interaktiv-dlya-lendingov-2026', heroIcon: 'ph-fill ph-sparkle',
    ...
    metaDescription: 'PixiJS — open-source 2D-движок рендеринга на WebGL: скретч-карты «сотри и выиграй», интерактивные баннеры, анимации и мини-игры для лендингов и рассылок.',
  ...
  E({ slug: 'godot-trenazhery-obucheniya-2026', heroIcon: 'ph-fill ph-student',
    ...
    metaDescription: 'Godot — свободный игровой движок для serious games и тренажёров: онбординг, охрана труда, отработка процедур и продаж в игровой форме, с экспортом в web.',
