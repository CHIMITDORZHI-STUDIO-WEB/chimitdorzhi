...
module.exports = [
  ...
  E({ slug: 'nastroyka-152fz-pod-klyuch-2027', heroIcon: 'ph-fill ph-shield-check', ctaInternal: SEC,
    ...
    metaDescription: 'Настройка 152-ФЗ под ключ: что входит в работу (аудит обработки данных, документы и согласия, уведомление в РКН, политика, базовая защита).',
  ...
  E({ slug: 'zakazat-sayt-biznes-chita-2027', heroIcon: 'ph-fill ph-globe', ctaInternal: WEB,
    ...
    metaDescription: 'Заказать сайт для бизнеса в Чите и Забайкалье: какие бывают сайты и что выбрать, что входит в работу, этапы и сроки.',
  ...
  E({ slug: 'kak-vybrat-it-podryadchika-2027', heroIcon: 'ph-fill ph-clipboard-text', ctaInternal: PRED,
    ...
    metaDescription: 'Как выбрать IT-подрядчика для бизнеса: на что смотреть (опыт, отзывы, договор, передача исходников, поддержка, кто отвечает за результат).',
  ...
  E({ slug: 'it-soprovozhdenie-biznesa-2027', heroIcon: 'ph-fill ph-lifebuoy', ctaInternal: PRED,
    ...
    metaDescription: 'Абонентское IT-сопровождение или разовые задачи: что входит, кому что выгоднее, от чего зависит цена и как не остаться без поддержки после запуска.',
