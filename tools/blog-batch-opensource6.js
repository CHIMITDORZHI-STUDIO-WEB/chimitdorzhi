...
module.exports = [
  E({ slug: 'viseron-ai-videonablyudenie-2026', heroIcon: 'ph-fill ph-video-camera',
    ...
    metaDescription: 'Viseron — open-source система видеонаблюдения с ИИ: распознавание людей, машин и движения, запись по событиям, всё локально без облака.',
  ...
  E({ slug: 'catvton-virtualnaya-primerka-2026', heroIcon: 'ph-fill ph-t-shirt',
    ...
    metaDescription: 'CatVTON — open-source AI-модель виртуальной примерки одежды: фото человека + вещь = реалистичный результат «как сидит».',
  ...
  E({ slug: 'moss-tts-nano-sintez-rechi-2026', heroIcon: 'ph-fill ph-waveform',
    ...
    metaDescription: 'MOSS-TTS-Nano — open-source компактная модель синтеза речи (TTS): до 20 языков, работает на CPU, клонирование голоса и стриминг.',
  ...
  E({ slug: 'moneyprinterturbo-ai-video-2026', heroIcon: 'ph-fill ph-film-slate',
    ...
    metaDescription: 'MoneyPrinterTurbo — open-source инструмент авто-генерации коротких видео для соцсетей: тема → сценарий, видеоряд, субтитры, музыка.',
