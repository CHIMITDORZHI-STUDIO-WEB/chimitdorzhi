...
module.exports = [
  E({ slug: 'baserow-baza-dannyh-bez-koda-2026', heroIcon: 'ph-fill ph-table',
    ...
    metaDescription: 'Baserow — open-source база данных без кода (аналог Airtable): таблицы, связи, формы, без платы за пользователя.',
  ...
  E({ slug: 'coolify-svoya-platforma-deploya-2026', heroIcon: 'ph-fill ph-cloud-arrow-up',
    ...
    metaDescription: 'Coolify — open-source платформа деплоя приложений и сервисов (аналог Vercel/Heroku/Netlify): развёртывание сайтов.',
  ...
  E({ slug: 'posthog-produktovaya-analitika-2026', heroIcon: 'ph-fill ph-chart-donut',
    ...
    metaDescription: 'PostHog — open-source платформа продуктовой аналитики (аналог Mixpanel/Amplitude): события, воронки, запись сессий, A/B-тесты, фиче-флаги.',
  ...
  E({ slug: 'medusa-headless-magazin-2026', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Medusa — open-source headless-платформа для интернет-магазина (аналог Shopify, гибче и без комиссий): API-first, кастомная витрина, заказы, платежи.',
  ...
  E({ slug: 'supabase-backend-dlya-prilozheniy-2026', heroIcon: 'ph-fill ph-database',
    ...
    metaDescription: 'Supabase — open-source backend-платформа (аналог Firebase): база PostgreSQL, авторизация, API, файловое хранилище, реалтайм.',
