...
module.exports = [
  E({ slug: 'docker-mailserver-pochtovyy-server-2026', heroIcon: 'ph-fill ph-envelope',
    ...
    metaDescription: 'docker-mailserver — open-source почтовый сервер в Docker: SMTP, IMAP, спам-фильтры, SSL.',
  ...
  E({ slug: 'bitwarden-menedzher-paroley-2026', heroIcon: 'ph-fill ph-key',
    ...
    metaDescription: 'Bitwarden (и лёгкий сервер Vaultwarden) — open-source менеджер паролей для команды: шифрование, общие хранилища, расширения и приложения.',
  ...
  E({ slug: 'chandra-ai-ocr-dokumenty-2026', heroIcon: 'ph-fill ph-scan',
    ...
    metaDescription: 'Chandra — open-source AI-OCR модель: превращает изображения и PDF в структурированные данные (таблицы, рукописный текст, формы, формулы, 90+ языков).',
  ...
  E({ slug: 'fooocus-generaciya-izobrazheniy-2026', heroIcon: 'ph-fill ph-image',
    ...
    metaDescription: 'Fooocus — open-source генерация изображений по тексту (на базе Stable Diffusion, аналог Midjourney): качественные картинки локально.',
  ...
  E({ slug: 'hermes-agent-ai-assistent-na-servere-2026', heroIcon: 'ph-fill ph-brain',
    ...
    metaDescription: 'Hermes-agent — open-source самообучающийся AI-агент на сервере: память между сессиями, создание навыков, задачи по расписанию через мессенджеры.',
  ...
  E({ slug: 'agentic-inbox-ai-pochta-2026', heroIcon: 'ph-fill ph-envelope-open',
    ...
    metaDescription: 'agentic-inbox (Cloudflare) — open-source почтовый клиент с AI-агентом: читает входящие, ищет по переписке.',
