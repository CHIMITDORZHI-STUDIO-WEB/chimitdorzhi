...
module.exports = [
  ...
  mk({
    ...
    title: 'Напоминание о техосмотре, ОСАГО и ТО: как поставить и не проспать',
    metaTitle: 'Поставить напоминание о техосмотре и страховке ОСАГО',
    metaDescription: 'Как поставить напоминание о техосмотре, страховке ОСАГО и замене масла: в телефоне, в Telegram/MAX-боте — и как автосервису напоминать клиентам автоматически.',
    metaKeywords: 'поставь напоминание о техосмотре, поставь напоминание о страховке, напоминание о страховке авто, напоминание осаго, напоминание техосмотр, когда менять масло, штраф без осаго, напоминания по авто, продление осаго напоминание',
