...
module.exports = [
  mk({
    ...
    metaDescription: 'Бумажная сервисная книжка теряется, а чеки за ТО копятся в бардачке. Как вести историю обслуживания машины в электронном виде, зачем это при продаже и как сделать такой сервис под себя.',
  ...
  mk({
    ...
    metaDescription: 'Топливо, ТО, страховка, ремонт, налог — реальная стоимость владения авто всегда выше цены покупки. Как вести учёт всех расходов на машину, что это показывает и как сделать удобный сервис для этого.',
  ...
  mk({
    ...
    metaDescription: 'Просроченный полис ОСАГО — штраф, а забытая замена масла — дорогой ремонт. Как настроить напоминания о датах по автомобилю, чтобы ничего не проспать, и как сделать такой сервис с уведомлениями.',
  ...
  mk({
    ...
    metaDescription: 'У малого бизнеса 2-10 машин, а системы мониторинга флота стоят как самолёт. Как вести учёт ТО, топлива, страховок и документов по каждой машине на своём сервере, без абонплаты за каждый автомобиль.',
  ...
  mk({
    ...
    metaDescription: 'Приложения для учёта авто удобны, но данные о ваших машинах, пробегах и расходах живут на чужих серверах. Чем свой сервер лучше, кому это важно и как развернуть учёт авто у себя.',
