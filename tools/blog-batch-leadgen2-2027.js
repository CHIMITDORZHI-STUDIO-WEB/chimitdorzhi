...
module.exports = [
  ...
  E({ slug: 'ii-agent-zayavki-s-sayta-crm-2027', heroIcon: 'ph-fill ph-robot', category: 'ai-dev', ctaInternal: CTA_BOT,
    ...
    metaTitle: 'ИИ-агент для сайта: заявки 24/7 и занесение в CRM',
    metaDescription: 'ИИ-агент для сайта работает как AI-консультант: отвечает клиенту круглосуточно, квалифицирует лида и сам заносит заявку в CRM. Что нужно для запуска.',
  ...
  E({ slug: 'ii-otvety-na-otzyvy-wb-ozon-2027', heroIcon: 'ph-fill ph-chat-circle-dots', category: 'ai-dev', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Как ИИ-агент отвечает на отзывы и вопросы покупателей на Wildberries и Ozon вместо селлера: держит тон бренда, отрабатывает негатив и экономит часы в день.',
  ...
  E({ slug: 'ii-razbor-vhodyashchey-pochty-dokumentov-2027', heroIcon: 'ph-fill ph-envelope-open', category: 'ai-dev', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Как ИИ-агент разбирает входящую почту и документы: сортирует письма по темам, извлекает данные из счетов и заявок и передаёт их в нужную систему.',
  ...
  E({ slug: 'bot-zapis-v-2-klika-2027', heroIcon: 'ph-fill ph-calendar-check', category: 'ai-dev', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Как бот записи в мессенджере заменяет звонок администратору: клиент выбирает услугу, мастера и время в пару касаний, а запись сразу падает в расписание.',
  ...
  E({ slug: 'avtootchety-rukovoditelyu-telegram-2027', heroIcon: 'ph-fill ph-chart-bar', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Как настроить автоотчёты руководителю в Telegram: каждое утро бот присылает выручку, число заявок, конверсию и статус задач без ручного сбора данных.',
  ...
  E({ slug: 'priem-zayavok-s-avito-v-crm-2027', heroIcon: 'ph-fill ph-arrows-merge', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Как автоматически передавать заявки и сообщения с Авито в CRM: каждый новый лид сразу попадает в воронку с источником и контактом, без копирования вручную.',
  ...
  E({ slug: 'svoy-vidzhet-onlayn-chata-2027', heroIcon: 'ph-fill ph-chat-teardrop-text', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Свой виджет чата вместо ушедших зарубежных сервисов: диалоги падают менеджеру в Telegram, история хранится у вас, абонентки в валюте нет.',
  ...
  E({ slug: 'bot-kviz-raschet-smety-2027', heroIcon: 'ph-fill ph-calculator', category: 'development', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Как бот-квиз считает смету прямо в переписке: клиент отвечает на несколько вопросов и получает вилку цены, а вы — тёплый лид с параметрами заказа.',
  ...
  E({ slug: 'avtomatizaciya-schetov-aktov-2027', heroIcon: 'ph-fill ph-receipt', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Счета и акты вручную съедают часы. Как система сама лепит документы из заявки, подставляет реквизиты и шлёт клиенту: механика и цена.',
  ...
  E({ slug: 'bot-avtootvetchik-nerabochee-vremya-2027', heroIcon: 'ph-fill ph-moon', category: 'development', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Бот-автоответчик ловит лида ночью: мгновенный ответ, сбор контакта и запроса, а утром менеджер видит тёплую заявку. Сколько заявок спасает и цена.',
  ...
  E({ slug: 'lichnyy-kabinet-klienta-okupaemost-2027', heroIcon: 'ph-fill ph-user-circle-gear', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Разбираю, когда личный кабинет клиента реально окупается, а когда это выброшенные деньги: какому бизнесу он нужен, какие задачи решает.',
  ...
  E({ slug: 'uyti-s-tildy-wix-na-svoy-sayt-2027', heroIcon: 'ph-fill ph-arrow-square-out', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Абонентка растёт, а нужных функций всё нет. Признаки, что конструктор упёрся в потолок, и как перенести сайт на свой движок без потери трафика.',
  ...
  E({ slug: 'edinoe-okno-zayavok-omnikanalnost-2027', heroIcon: 'ph-fill ph-squares-four', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Заявки с сайта, телефона, Директа и мессенджеров в одном окне: менеджер отвечает из одного интерфейса, лиды не теряются. Как устроено и сколько стоит.',
  ...
  E({ slug: 'svoya-onlayn-zapis-zamena-calendly-2027', heroIcon: 'ph-fill ph-calendar-plus', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Как сделать свою онлайн-запись вместо ушедшего Calendly: запись под ваши услуги и мастеров, напоминания клиенту.',
  ...
  E({ slug: 'pochemu-sayt-ne-prinosit-zayavok-audit-2027', heroIcon: 'ph-fill ph-magnifying-glass', category: 'development', ctaInternal: CTA_WEB,
    ...
    metaDescription: 'Почему сайт есть, а заявок нет: разбираю 12 частых причин — от медленной загрузки и неочевидной формы до отсутствия оффера и мобильной вёрстки.',
  ...
  E({ slug: 'kak-sostavit-tz-na-sayt-bot-2027', heroIcon: 'ph-fill ph-clipboard-text', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Как составить техзадание на сайт или бот, чтобы не переплатить и получить нужный результат: что обязательно включить.',
  ...
  E({ slug: 'skolko-stoit-avtomatizaciya-okupaemost-2027', heroIcon: 'ph-fill ph-coins', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaTitle: 'Окупаемость автоматизации: как посчитать ROI',
    metaDescription: 'Сколько стоит автоматизация бизнеса и когда она окупается: от чего зависит цена, пример расчёта окупаемости на сэкономленных часах.',
  ...
  E({ slug: 'zakazat-ii-agenta-chita-ulan-ude-2027', heroIcon: 'ph-fill ph-map-pin', category: 'development', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Где заказать ИИ-агента в Чите и Улан-Удэ и что автоматизируют местные бизнесы: ответы на заявки, запись клиентов, обработка отзывов и рутины.',
  ...
  E({ slug: 'vnedrenie-crm-zabaykalye-2027', heroIcon: 'ph-fill ph-kanban', category: 'development', ctaInternal: CTA_GEN,
    ...
    metaDescription: 'Внедрение CRM в Забайкалье для малого бизнеса: зачем она нужна, с чего начать, какую систему выбрать под задачи и бюджет и какие этапы проходит внедрение.',
  ...
  E({ slug: 'bot-zapis-klientov-ulan-ude-2027', heroIcon: 'ph-fill ph-storefront', category: 'development', ctaInternal: CTA_BOT,
    ...
    metaDescription: 'Бот для записи клиентов в Улан-Удэ для салонов, клиник и автосервисов: клиент записывается в мессенджере в пару касаний.',
