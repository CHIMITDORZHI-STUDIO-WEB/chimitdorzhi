...
module.exports = [
  E({ slug: 'belyy-leybl-onlayn-zakaza-dlya-kafe-2027', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса ChowNow: белый лейбл онлайн-заказа, который кафе подключает на свой сайт и в приложение.',
  ...
  E({ slug: 'besplatnaya-razdacha-lishney-edy-sosedyam-2027', heroIcon: 'ph-fill ph-hand-heart',
    ...
    metaDescription: 'Приложение Olio: соседи бесплатно отдают лишнюю еду, кафе и магазины — остатки после закрытия. Почему в России идея живёт разрозненно.',
  ...
  E({ slug: 'podpiska-na-produkty-ot-fermerov-2027', heroIcon: 'ph-fill ph-carrot',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Farmstead: подписка на регулярную доставку свежих продуктов напрямую от местных фермеров.',
  ...
  E({ slug: 'qr-zakaz-i-oplata-scheta-za-stolom-2027', heroIcon: 'ph-fill ph-qr-code',
    ...
    metaDescription: 'Разбираю модель зарубежного сервиса Bbot: гость сканирует QR-код за столом, заказывает и оплачивает счёт сам через телефон, без ожидания официанта.',
  ...
  E({ slug: 'svoya-kurerskaya-sluzhba-restorana-2027', heroIcon: 'ph-fill ph-bicycle',
    ...
    metaTitle: 'Homer Logistics по-русски: своя курьерская служба под',
    metaDescription: 'Разбираю модель зарубежного сервиса Homer Logistics: курьерская служба, которая доставляет заказы под брендом самого ресторана.',
  ...
  E({ slug: 'uchet-sebestoimosti-blyud-i-zakupok-2027', heroIcon: 'ph-fill ph-calculator',
    ...
    metaDescription: 'Кафе теряет маржу, когда не знает себестоимость блюда. Разбираю модель MarketMan: расчёт по рецепту и ценам поставщиков автоматически, без Excel.',
