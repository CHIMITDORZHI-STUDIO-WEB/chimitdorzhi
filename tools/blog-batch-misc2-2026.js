...
module.exports = [
  E({ slug: 'ugon-akkaunta-telegram-max-zashchita-2026', heroIcon: 'ph-fill ph-lock-key-open', ctaInternal: SEC,
    ...
    metaDescription: 'Как угоняют аккаунты в Telegram и MAX (МАКС) и как защититься: двухэтапная аутентификация, осторожность с кодами и ссылками, проверка сессий.',
  ...
  E({ slug: 'cifrovaya-gigiena-rukovoditelya-2026', heroIcon: 'ph-fill ph-shield-star', ctaInternal: SEC,
    ...
    metaDescription: 'Цифровая гигиена для руководителя: почему директор — цель №1, правила (менеджер паролей, 2FA, защита от фишинга, разделение личного и рабочего).',
  ...
  E({ slug: 'triggernye-cepochki-soobshcheniy-2026', heroIcon: 'ph-fill ph-flow-arrow', ctaInternal: AUTO,
    ...
    metaDescription: 'Триггерные цепочки: welcome-серия, брошенная корзина, реактивация, отзывы. Каналы e-mail, Telegram, MAX и SMS, настройка, согласия и 152-ФЗ.',
  ...
  E({ slug: 'reperposing-kontenta-1-v-10-2026', heroIcon: 'ph-fill ph-copy', ctaInternal: DM,
    ...
    metaDescription: 'Репёрпосинг контента: как из одной статьи, подкаста или вебинара сделать десяток форматов под VK, Telegram, MAX, YouTube/Rutube, Дзен и рассылку.',
  ...
  E({ slug: 'zapusk-onlayn-kursa-tehchast-2026', heroIcon: 'ph-fill ph-graduation-cap', ctaInternal: PRED,
    ...
    metaDescription: 'Техническая часть запуска онлайн-курса: платформа (готовая или своя на сервере), приём оплаты и автоматическая выдача доступа, личный кабинет.',
  ...
  E({ slug: 'ii-dlya-lichnyh-finansov-2026', heroIcon: 'ph-fill ph-wallet', ctaInternal: AGENTS,
    ...
    metaDescription: 'ИИ для личных финансов: категоризация трат, анализ расходов, напоминания о платежах, помощь с бюджетом и разбор подписок.',
