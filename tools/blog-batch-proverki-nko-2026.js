...
module.exports = [
  ...
  E({ slug: 'proverit-dolgi-fssp-kontragenta-2026', category: 'legal', heroIcon: 'ph-fill ph-magnifying-glass',
    ...
    metaDescription: 'Как проверить долги через ФССП, исполнительные производства, банкротство и лицензии контрагента бесплатно, что смотреть перед сделкой и как автоматизировать массовую проверку по API.',
  ...
  E({ slug: 'otchetnost-nko-2026', category: 'legal', heroIcon: 'ph-fill ph-file-text',
    ...
    metaDescription: 'Отчётность НКО: какие отчёты сдаёт некоммерческая организация (Минюст, налоговая, фонды), сроки, частые ошибки и как автоматизировать сбор данных и подготовку отчётности.',
  ...
  E({ slug: 'programma-dlya-nko-2026', category: 'industries', heroIcon: 'ph-fill ph-heart',
    ...
    metaDescription: 'Программа для НКО и фондов: как автоматизировать приём и учёт пожертвований, вести CRM доноров и волонтёров, показывать прозрачность расходов и собирать отчётность. Готовое и своё.',
  ...
  E({ slug: 'programma-kontrolya-sotrudnikov-152fz-2026', category: 'legal', heroIcon: 'ph-fill ph-eye',
    ...
    metaDescription: 'Программы контроля сотрудников: что можно отслеживать законно, а что нарушает 152-ФЗ и тайну переписки, как правильно оформить согласия и уведомления и как внедрить контроль без рисков.',
  ...
  E({ slug: 'uchet-rabochego-vremeni-tabel-2026', category: 'development', heroIcon: 'ph-fill ph-clock',
    ...
    metaDescription: 'Учёт рабочего времени и табель: как вести без хаоса — от Excel-шаблона до автоматизации (отметки, графики смен, переработки, интеграция с 1С), когда пора уходить с таблиц.',
  ...
  E({ slug: 'tehnicheskiy-audit-sayta-404-2026', category: 'development', heroIcon: 'ph-fill ph-bug',
    ...
    metaDescription: 'Технический аудит сайта: что такое ошибка 404 и как её исправить, как найти битые ссылки, настроить robots.txt и sitemap.xml, добавить микроразметку — чтобы сайт лучше индексировался.',
  ...
  E({ slug: 'monitoring-cen-konkurentov-2026', category: 'marketing', heroIcon: 'ph-fill ph-download-simple',
    ...
    metaTitle: 'Мониторинг цен конкурентов: сервисы и парсер',
    metaDescription: 'Мониторинг цен конкурентов: зачем следить за ценами, какие сервисы есть, что можно парсить легально и когда выгоднее свой парсер под ваши источники с выгрузкой в таблицу или CRM.',
  ...
  E({ slug: 'skripty-prodazh-v-crm-2026', category: 'sales', heroIcon: 'ph-fill ph-chats-circle',
    ...
    metaDescription: 'Скрипты продаж: как их составить, зачем внедрять прямо в CRM (подсказки менеджеру, этапы, автозаполнение), как связать с мотивацией по KPI и премиями и как это поднимает конверсию.',
