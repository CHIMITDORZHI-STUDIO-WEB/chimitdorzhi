...
module.exports = [
  ...
  E({ slug: 'monitoring-cen-konkurentov-2026', category: 'marketing', heroIcon: 'ph-fill ph-download-simple',
    ...
    metaDescription: 'Мониторинг цен конкурентов: какие сервисы есть, что можно парсить легально и когда выгоднее свой парсер под ваши источники с выгрузкой в CRM.',
