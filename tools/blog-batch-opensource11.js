...
module.exports = [
  E({ slug: 'linkstack-multissylka-2026', heroIcon: 'ph-fill ph-link',
    ...
    metaDescription: 'LinkStack — open-source мультиссылка (link-in-bio, аналог Taplink/Linktree): все контакты, соцсети, каталог и запись на одной странице на своём домене.',
  ...
  E({ slug: 'shlink-korotkie-ssylki-analitika-2026', heroIcon: 'ph-fill ph-link-simple-horizontal',
    ...
    metaDescription: 'Shlink — open-source сокращатель ссылок с аналитикой (аналог Bitly): короткие ссылки на своём домене, статистика переходов, QR-коды, метки.',
  ...
  E({ slug: 'bigbluebutton-vebinary-2026', heroIcon: 'ph-fill ph-chalkboard-teacher',
    ...
    metaDescription: 'BigBlueButton — open-source платформа вебинаров и онлайн-обучения: видео, доска, опросы, комнаты, запись.',
  ...
  E({ slug: 'akaunting-uchet-scheta-2026', heroIcon: 'ph-fill ph-calculator',
    ...
    metaDescription: 'Akaunting — open-source система учёта финансов и счетов для малого бизнеса (аналог QuickBooks): доходы, расходы, счета, клиенты, отчёты.',
  ...
  E({ slug: 'opensign-elektronnaya-podpis-2026', heroIcon: 'ph-fill ph-signature',
    ...
    metaDescription: 'OpenSign — open-source сервис электронной подписи документов (аналог DocuSign): отправка на подпись, поля, шаблоны, статус, аудит.',
  ...
  E({ slug: 'matomo-veb-analitika-2026', heroIcon: 'ph-fill ph-chart-pie-slice',
    ...
    metaDescription: 'Matomo — open-source веб-аналитика, полный аналог Google Analytics: посещаемость, источники, цели, карты кликов, без передачи данных Google.',
