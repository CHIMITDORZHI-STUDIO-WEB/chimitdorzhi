...
module.exports = [
  mk({
    ...
    metaDescription: 'Клиент подносит телефон к табличке — сразу открывается форма отзыва на Яндекс.',
  ...
  mk({
    ...
    metaDescription: 'Тап телефоном по карте — и открывается профиль с контактами, мессенджерами и кнопкой сохранить. Как устроена NFC-визитка и как сделать сервис.',
  ...
  mk({
    ...
    metaDescription: 'Обзор: как бизнес использует NFC-метки — сбор отзывов, электронные визитки, лояльность, паспорт техники, пропуски, меню, оплата.',
