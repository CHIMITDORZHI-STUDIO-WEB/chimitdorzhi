...
const BATCHES = ['opensource', 'opensource2', 'opensource3', 'opensource4', 'opensource5',
  'opensource6', 'opensource7', 'opensource8', 'opensource9', 'opensource10', 'opensource11', 'opensource12', 'opensource13', 'opensource14', 'opensource15', 'opensource16', 'opensource17', 'opensource18', 'opensource19', 'opensource20', 'opensource21', 'opensource22', 'opensource23', 'opensource24', 'opensource25'];
...
module.exports = [{
  ...
  metaDescription: 'Каталог бесплатных open-source решений для бизнеса по задачам: CRM, аналитика, документы, почта, безопасность, магазины, AI.',
