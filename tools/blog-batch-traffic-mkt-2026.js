...
module.exports = [
  E({ slug: 'seo-prodvizhenie-sayta-2026', category: 'marketing', heroIcon: 'ph-fill ph-magnifying-glass',
    ...
    metaDescription: 'SEO-продвижение сайта в 2026: что реально влияет на позиции — контент, скорость, ссылки, GEO. Через сколько ждать результат и сколько это стоит.',
  ...
  E({ slug: 'prodvizhenie-na-avito-2026', category: 'marketing', heroIcon: 'ph-fill ph-storefront',
    ...
    metaDescription: 'Продвижение на Авито в 2026: как работает ранжирование, какие способы поднять объявления реально дают заявки, частые ошибки и как связать Авито с CRM.',
  ...
  E({ slug: 'onlayn-buhgalteriya-sravnenie-2026', category: 'finance', heroIcon: 'ph-fill ph-calculator',
    ...
    metaDescription: 'Онлайн-бухгалтерия для ИП: сравниваю Контур.Эльбу, Моё дело и Т-Банк по возможностям и цене, кому какой сервис подходит и что автоматизировать.',
  ...
  E({ slug: 'analitika-wildberries-servisy-2026', category: 'marketing', heroIcon: 'ph-fill ph-chart-bar',
    ...
    metaDescription: 'Аналитика Wildberries для селлера: какие метрики отслеживать (выкуп, оборачиваемость, реклама, юнит-экономика).',
  ...
  E({ slug: 'dvuhfaktornaya-autentifikaciya-gid-2026', category: 'security', heroIcon: 'ph-fill ph-lock-key',
    ...
    metaDescription: 'Двухфакторная аутентификация простыми словами: что такое 2FA, какие виды бывают (SMS, приложения, ключи).',
  ...
  E({ slug: 'samozapret-na-kredity-gosuslugi-2026', category: 'security', heroIcon: 'ph-fill ph-hand-palm',
    ...
    metaDescription: 'Самозапрет на кредиты через Госуслуги: что это, как он защищает от мошенников, как установить и снять пошагово и какие есть нюансы.',
  ...
  E({ slug: 'vzlomali-gosuslugi-chto-delat-2026', category: 'security', heroIcon: 'ph-fill ph-warning-octagon',
    ...
    metaDescription: 'Взломали Госуслуги — что делать в первый час: пошаговый план восстановления доступа, как отозвать доступы.',
