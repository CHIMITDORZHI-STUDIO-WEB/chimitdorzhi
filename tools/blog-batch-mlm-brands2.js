...
module.exports = [
  E({
    ...
    metaDescription: 'Орифлэйм без ярлыков: что за компания, продукт и каталог, как устроен доход, кому подходит, какие риски и как начать. Без обещаний заработка.',
  ...
  E({
    ...
    metaDescription: 'NL International из Новосибирска: питание Energy Diet и косметика, как устроены бизнес и доход, кому подходит, плюсы и риски. Без обещаний.',
