...
module.exports = [
  E({
    ...
    title: 'Орифлейм (Oriflame): что это за компания и реально ли заработать',
    metaTitle: 'Орифлейм (Oriflame): что это за компания — честный обзор',
    metaDescription: 'Орифлейм (Oriflame) — что это за компания: продукт и каталог, как стать представителем, как устроен доход, кому подходит и какие риски. Без обещаний заработка.',
    metaKeywords: 'орифлейм, орифлэйм, oriflame, орифлейм это, что такое орифлейм, орифлейм стать представителем, орифлейм бизнес, орифлейм как заработать, орифлейм каталог, отзывы',
  ...
  E({
    ...
    metaDescription: 'Эйвон (Avon) без ярлыков и обещаний дохода: что за компания, каталог и продукт, как устроен заработок, кому подходит, плюсы, риски, старт.',
  ...
  E({
    ...
    metaDescription: 'Амвэй (Amway) без обещаний дохода: что за компания, товары для дома и питание Nutrilite, как устроен заработок, кому подходит и где риски.',
  ...
  E({
    ...
    metaTitle: 'НЛ Интернешнл (NL International): что это — честный обзор',
    metaDescription: 'НЛ Интернешнл (NL International) — что это за компания: производитель Energy Diet и косметики из Новосибирска, как устроены бизнес и доход, плюсы и риски.',
    metaKeywords: 'nl international, нл интернешнл, что такое нл, нл что это, нл интернейшнл, energy diet, нл бизнес, nl как заработать, отзывы',
  ...
  E({
    ...
    metaDescription: 'Сравнение Орифлэйм, Сибирское здоровье и Фаберлик: чем отличаются продукт, бизнес-модель и каталог, кому что ближе и как выбрать компанию под себя.',
