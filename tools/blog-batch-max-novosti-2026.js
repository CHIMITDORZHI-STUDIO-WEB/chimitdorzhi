...
module.exports = [
  ...
  mk({
    ...
    toc: toc(['chto-eto','Что за эфиры в MAX'],['zachem','Зачем бизнесу'],['scenarii','Сценарии эфиров'],['kak-provesti','Как провести эфир'],['kak-rastit-zriteley','Как растить зрителей эфиров'],['faq','Частые вопросы'],['vyvody','Коротко о главном']),
  ...
  mk({
    ...
    metaTitle: 'Интеграция MAX с CRM: заявки в одном месте',
