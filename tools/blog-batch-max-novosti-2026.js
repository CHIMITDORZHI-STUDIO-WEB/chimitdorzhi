...
module.exports = [
  mk({
    ...
    metaDescription: 'Обзор новых функций мессенджера MAX в 2026: истории, комментарии в каналах, прямые эфиры, счётчики просмотров и что ещё на подходе.',
  ...
  mk({
    ...
    metaDescription: 'В MAX появились прямые эфиры прямо в каналах и чатах. Разбираю, как провести стрим в MAX, что показывать бизнесу и как превратить эфир в заявки.',
  ...
  mk({
    ...
    metaDescription: 'MAX больше не скачать из Google Play. Рабочие способы установить MAX на Android и iPhone: RuStore, официальный сайт, APK — и как не поймать подделку.',
