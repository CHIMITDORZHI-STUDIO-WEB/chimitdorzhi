...
module.exports = [
  E({ slug: 'open-hardware-otkrytoe-zhelezo-2026', heroIcon: 'ph-fill ph-circuitry', ctaInternal: OS,
    ...
    metaDescription: 'Открытое железо (open hardware) простыми словами: аппаратные проекты с открытыми схемами и прошивками (Arduino, Prusa, Raspberry Pi, RISC-V).',
  ...
  E({ slug: '3d-pechat-dlya-biznesa-prusa-2026', heroIcon: 'ph-fill ph-cube', ctaInternal: PRED,
    ...
    metaDescription: '3D-печать для бизнеса на Prusa и открытых решениях: быстрые прототипы, запчасти и оснастка под заказ, мелкосерийное производство.',
  ...
  E({ slug: 'iot-na-otkrytom-zheleze-dlya-biznesa-2026', heroIcon: 'ph-fill ph-thermometer', ctaInternal: AUTO,
    ...
    metaDescription: 'IoT на открытом железе для бизнеса: недорогие датчики и контроллеры (Arduino, ESP32) с открытой прошивкой ESPHome для мониторинга температуры.',
  ...
  E({ slug: 'raspberry-pi-dlya-biznesa-2026', heroIcon: 'ph-fill ph-circuit-board', ctaInternal: OS,
    ...
    metaDescription: 'Raspberry Pi для бизнеса: недорогой одноплатный компьютер под информационное табло, инфо-киоск, мини-сервер и видеонаблюдение — что он реально потянет.',
  ...
  E({ slug: 'chpu-lazernaya-rezka-open-source-2026', heroIcon: 'ph-fill ph-scissors', ctaInternal: PRED,
    ...
    metaDescription: 'ЧПУ и лазерная резка на открытом железе для малого производства: станки с открытой прошивкой (GRBL) для деталей, гравировки, вывесок и мелкосерийки.',
