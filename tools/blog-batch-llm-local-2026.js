...
module.exports = [
  E({ slug: 'llama-cpp-zapusk-i-optimizaciya-2026', heroIcon: 'ph-fill ph-cpu', ctaInternal: OS,
    ...
    metaDescription: 'llama.cpp простыми словами: open-source движок для запуска локальных LLM на своём железе. Чем отличается от Ollama и LM Studio, как запустить (GGUF.',
  ...
  E({ slug: 'skolko-zheleza-nuzhno-lokalnomu-ii-2026', heroIcon: 'ph-fill ph-graphics-card', ctaInternal: AGENTS,
    ...
    metaDescription: 'Сколько железа нужно для локального ИИ: разбор по VRAM, RAM и квантизации.',
