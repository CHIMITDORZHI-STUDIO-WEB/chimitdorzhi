...
const i18nUi = {
  ru: {
    ...
    'svc.catalog.sub':           '46 услуг в 9 направлениях для бизнеса в России и СНГ. Помогаю компаниям внедрять AI-агентов и LLM-решения, выстраивать архитектуру IT-систем, защищать сайты под 152-ФЗ, выпускать ЦФА по 259-ФЗ, проводить цифровизацию клиник и логистики, обучать команды работе с нейросетями. Работаю удалённо по всему миру — город и часовой пояс заказчика не мешают запуску. Опыт 16+ лет в IT, 5+ в AI/ML, сертификаты Vanderbilt University и MongoDB Inc. (2026). Каждая услуга — отдельная посадочная страница с описанием, факторами стоимости и связанными услугами. Цены ориентировочные «от X ₽» — финальная стоимость определяется индивидуально после согласования ТЗ.',
  },
  en: {
    'svc.filter.all':            'All',
