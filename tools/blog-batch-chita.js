...
module.exports = [
  E({
    ...
    metaDescription: 'Как запустить доставку еды в Чите: с чего начать, как принимать заказы (сайт, бот или агрегатор), логистика, оплата и учёт, продвижение в городе.',
  ...
  E({
    ...
    metaDescription: 'Свой интернет-магазин или маркетплейс для продавца в Чите: плюсы и минусы, экономика (комиссии, реклама, маржа).',
  ...
  E({
    ...
    metaDescription: 'Настройка Яндекс.Директа для бизнеса в Чите: зачем он местному бизнесу, настройка по шагам, геотаргетинг на Читу и районы Забайкалья, бюджет и ставки.',
  ...
  E({
    ...
    metaDescription: 'Меры поддержки и гранты для бизнеса в Забайкальском крае 2026: какие виды поддержки бывают (гранты, субсидии, льготные займы, центр «Мой бизнес»).',
  ...
  E({
    ...
    metaDescription: 'Внедрение CRM Битрикс24 для компании в Чите: зачем нужна CRM, возможности Битрикс24, внедрение по шагам, интеграции с телефонией, сайтом и 1С.',
  ...
  E({
    ...
    metaDescription: 'Автоматизация бизнеса в Чите и Забайкалье: с чего начать малому бизнесу, что автоматизировать в первую очередь, примеры по местным нишам.',
