...
module.exports = [
  E({ slug: 'whisperx-transkribaciya-rechi-2026', heroIcon: 'ph-fill ph-microphone',
    ...
    metaDescription: 'WhisperX — open-source распознавание речи с точными таймкодами и определением говорящих: расшифровка совещаний, интервью, подкастов, субтитры.',
  ...
  E({ slug: 'opendronemap-obrabotka-dron-semki-2026', heroIcon: 'ph-fill ph-drone',
    ...
    metaDescription: 'OpenDroneMap (ODM) — open-source обработка снимков с дронов в геоданные: ортофотопланы, 3D-модели, облака точек, модели рельефа.',
  ...
  E({ slug: 'kimai-uchet-rabochego-vremeni-2026', heroIcon: 'ph-fill ph-timer',
    ...
    metaDescription: 'Kimai — open-source учёт рабочего времени: таймеры по проектам и клиентам, табели, отчёты, биллинг часов, роли, API.',
  ...
  E({ slug: 'syncthing-sinhronizaciya-faylov-2026', heroIcon: 'ph-fill ph-arrows-clockwise',
    ...
    metaDescription: 'Syncthing — open-source синхронизация файлов напрямую между устройствами (P2P), без облака-посредника: шифрование при передаче, версионность.',
  ...
  E({ slug: 'audiobookshelf-server-audioknig-podkastov-2026', heroIcon: 'ph-fill ph-headphones',
    ...
    metaDescription: 'AudioBookshelf — open-source сервер аудиокниг и подкастов: своя медиатека, стриминг на телефон, отметки прогресса, главы, мультипользователи.',
