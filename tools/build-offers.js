...
const SEGMENT_GROUPS = [
  { label: 'Отрасли', segs: ['Малый бизнес и услуги', 'Авто и транспорт', 'HoReCa и общепит', 'Развлечения и досуг', 'Недвижимость', 'Логистика и склад', 'Спорт и фитнес', 'Производство и стройка', 'Медицина и MedTech', 'Образование и EdTech', 'Маркетплейсы и e-commerce', 'Госсектор'] },
  { label: 'AI и технологии', segs: ['Запуск продукта и стартап', 'Корпоративный AI', 'Боты и AI', 'Зрение и роботизация'] },
  { label: 'Под задачу', segs: ['Маркетинг и трафик', 'Финтех и платежи', 'Комплексные платформы', 'Безопасность и аудит', 'Право', 'Геймификация', 'Сетевой бизнес (MLM)'] },
];
