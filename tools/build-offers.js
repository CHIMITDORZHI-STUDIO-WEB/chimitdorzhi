...
const SEGMENT_GROUPS = [
  ...
  { label: 'Под задачу', segs: ['Маркетинг и трафик', 'Вовлечение и вирусный рост', 'Медиа, контент и креаторы', 'Финтех и платежи', 'HR и команда', 'Безопасность и аудит', 'Право и документы', 'Комплексные платформы', 'Геймификация', 'Сетевой бизнес (MLM)'] },
];
