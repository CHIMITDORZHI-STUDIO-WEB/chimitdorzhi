...
const SEGMENT_GROUPS = [
  ...
  { label: 'Под задачу', segs: ['Мессенджер MAX', 'Маркетинг и трафик', 'Вовлечение и вирусный рост', 'Геймификация бизнеса', 'Медиа, контент и креаторы', 'Финтех и платежи', 'HR и команда', 'Безопасность и аудит', 'Право и документы', 'Комплексные платформы', 'Геймификация', 'Сетевой бизнес (MLM)'] },
];
