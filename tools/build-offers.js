...
const SEGMENT_GROUPS = [
  ...
  { label: 'Под задачу', segs: ['Маркетинг и трафик', 'Финтех и платежи', 'HR и команда', 'Безопасность и аудит', 'Право и документы', 'Комплексные платформы', 'Геймификация', 'Сетевой бизнес (MLM)'] },
];
