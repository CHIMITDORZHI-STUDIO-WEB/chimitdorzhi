...
const SEGMENT_GROUPS = [
  { label: 'Отрасли', segs: ['Розница и торговля', 'Бытовые услуги', 'Красота и здоровье', 'HoReCa и общепит', 'Авто и транспорт', 'Туризм и гостеприимство', 'Недвижимость', 'Развлечения и досуг', 'Спорт и фитнес', 'Медицина и MedTech', 'Образование и EdTech', 'АПК и фермерство', 'Производство и стройка', 'Логистика и склад', 'Маркетплейсы и e-commerce', 'Госсектор'] },
  { label: 'AI и технологии', segs: ['Запуск продукта и стартап', 'Корпоративный AI', 'Боты и AI', 'Зрение и роботизация'] },
  { label: 'Под задачу', segs: ['Маркетинг и трафик', 'Медиа, контент и креаторы', 'Финтех и платежи', 'HR и команда', 'Безопасность и аудит', 'Право и документы', 'Комплексные платформы', 'Геймификация', 'Сетевой бизнес (MLM)'] },
];
