...
const SEGMENT_GROUPS = [
  { label: 'Отрасли', segs: ['Малый бизнес и услуги', 'HoReCa и общепит', 'Развлечения и досуг', 'Недвижимость', 'Логистика и склад', 'Спорт и фитнес', 'Производство и стройка', 'Медицина и MedTech', 'Образование и EdTech', 'Маркетплейсы и e-commerce', 'Госсектор'] },
