...
module.exports = [
  E({ slug: 'bookstack-baza-znaniy-2026', heroIcon: 'ph-fill ph-books',
    ...
    metaDescription: 'BookStack — open-source база знаний и документация (аналог Confluence/Notion): книги, главы, страницы, поиск, права доступа.',
  ...
  E({ slug: 'jellyfin-svoya-mediateka-2026', heroIcon: 'ph-fill ph-television',
    ...
    metaDescription: 'Jellyfin — open-source медиасервер (аналог Plex): своя медиатека видео и музыки, стриминг на ТВ и устройства.',
  ...
  E({ slug: 'dify-ai-prilozheniya-2026', heroIcon: 'ph-fill ph-circuitry',
    ...
    metaDescription: 'Dify — open-source платформа для создания AI-приложений и ассистентов (LLMOps): конструктор, чат-боты с базой знаний (RAG), агенты, разные модели.',
  ...
  E({ slug: 'activepieces-prostaya-avtomatizaciya-2026', heroIcon: 'ph-fill ph-plugs-connected',
    ...
    metaDescription: 'Activepieces — open-source платформа автоматизации (аналог Zapier/Make, проще n8n): соединяет сервисы, сценарии, no-code, AI-шаги.',
  ...
  E({ slug: 'taiga-agile-doski-2026', heroIcon: 'ph-fill ph-kanban',
    ...
    metaDescription: 'Taiga — open-source система управления проектами по agile/scrum (аналог Jira): kanban и scrum-доски, бэклог, спринты, задачи.',
