...
module.exports = [
  E({ slug: 'agentnye-konveyery-ot-promptov-k-agentam-2026', heroIcon: 'ph-fill ph-flow-arrow', ctaInternal: AGENTS,
    ...
    metaDescription: 'Agent leap 2026: эра простых промптов заканчивается — ИИ оркестрирует сквозные процессы как «цифровые сборочные линии».',
  ...
  E({ slug: 'pochemu-ii-ne-okupaetsya-roi-razryv-2026', heroIcon: 'ph-fill ph-chart-line-down', ctaInternal: AUTO,
    ...
    metaDescription: 'Почему ИИ не окупается: большинство внедрили, но значимый ROI видит меньшинство.',
  ...
  E({ slug: 'okupaemost-ii-agentov-biznes-keys-2026', heroIcon: 'ph-fill ph-calculator', ctaInternal: AGENTS,
    ...
    metaDescription: 'Окупаемость ИИ-агентов в месяцах: по рыночным оценкам медиана ~5 месяцев, агенты в продажах (SDR) ~3-4, финансовые и операционные ~9.',
  ...
  E({ slug: 'malenkie-domennye-modeli-slm-2026', heroIcon: 'ph-fill ph-cube', ctaInternal: AGENTS,
    ...
    metaDescription: 'Маленькие доменные модели (SLM) вместо одного гиганта: при настройке под конкретную задачу они так же точны или точнее, дешевле и быстрее.',
  ...
  E({ slug: 'locateanything-nvidia-lokalnoe-raspoznavanie-2026', heroIcon: 'ph-fill ph-bounding-box', ctaInternal: AUTO,
    ...
    metaDescription: 'LocateAnything-3B — открытая модель компьютерного зрения от NVIDIA (3 млрд параметров): находит объекты даже в очень плотных сценах.',
  ...
  E({ slug: 'kak-ocenit-kachestvo-ii-bota-2027', heroIcon: 'ph-fill ph-gauge', ctaInternal: AGENTS,
    ...
    metaDescription: 'ИИ-бот отвечает хорошо или выдумывает? Метод LLM-as-Judge: как ИИ оценивает ответы ИИ через простые вопросы да/нет и где такая оценка врёт.',
    excerpt: 'Внедрили ИИ-бота — а как понять, что он отвечает хорошо, а не врёт? Разбираю LLM-as-Judge (ИИ проверяет ИИ) и метод разбивки критериев на вопросы «да/нет». Зачем бизнесу измерять качество ИИ и как это делать на практике.',
    tags: ['оценка ИИ', 'LLM-as-Judge', 'качество ИИ', 'ИИ-агенты'],
    toc: [
      { id: 'chto-eto', text: 'Зачем измерять качество ИИ' },
      { id: 'problema', text: 'Почему «вроде норм» не работает' },
      { id: 'kak-rabotaet', text: 'LLM-as-Judge и метод да/нет' },
      { id: 'kak-primenit', text: 'Как применить в бизнесе' },
      { id: 'oshibki', text: 'Где оценка ошибается' },
      { id: 'faq', text: 'FAQ' },
      { id: 'vyvody', text: 'Коротко о главном' },
    ],
    relatedSlugs: ['ii-galyucinacii-nelzya-slepo-doveryat-2026', 'rag-sistemy-dlya-biznesa-2026', 'kak-sozdat-ai-agenta-2026'] }),
];
