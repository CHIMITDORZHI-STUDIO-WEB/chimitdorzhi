...
module.exports = [
  ...
  E({ slug: 'integraciya-sayta-s-1c-2026', category: 'development', heroIcon: 'ph-fill ph-plugs-connected',
    ...
    metaTitle: 'Интеграция сайта с 1С: товары, заказы, остатки',
    metaDescription: 'Интеграция сайта с 1С: как автоматически синхронизировать товары, цены, остатки и заказы между сайтом и 1С, какие есть способы обмена, сроки и стоимость разработки под ключ.',
    metaKeywords: 'интеграция сайта с 1с, обмен сайта с 1с, синхронизация 1с и сайта, выгрузка товаров из 1с, заказы с сайта в 1с',
    excerpt: 'Как связать сайт и 1С: автоматическая синхронизация товаров, цен, остатков и заказов, какие есть способы обмена, сроки и стоимость под ключ.',
    tags: ['1С', 'интеграция', 'интернет-магазин', 'обмен'],
    toc: T([{ id: 'zachem', text: 'Что даёт интеграция' }, { id: 'chto-sinhron', text: 'Что синхронизируют' }, { id: 'sposoby', text: 'Способы обмена' }, { id: 'cena', text: 'Сроки и цена' }]),
