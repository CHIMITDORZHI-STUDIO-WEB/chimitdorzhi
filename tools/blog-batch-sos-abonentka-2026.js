...
module.exports = [
  ...
  E({ slug: 'sayt-ne-rabotaet-diagnostika-2026', category: 'development', heroIcon: 'ph-fill ph-first-aid',
    ...
    metaDescription: 'Сайт не работает — что делать: быстрая диагностика за 10 минут (хостинг, домен, SSL, код, блокировки), как понять причину.',
  ...
  E({ slug: 'ne-prihodyat-zayavki-s-sayta-2026', category: 'development', heroIcon: 'ph-fill ph-envelope-simple-open',
    ...
    metaDescription: 'Заявки с сайта пропадают? 7 причин: форма не отправляет, письма в спаме, сломалась интеграция с CRM, нет уведомлений. Как проверить каждую.',
  ...
  E({ slug: 'perenesti-sayt-domen-bez-prostoya-2026', category: 'development', heroIcon: 'ph-fill ph-swap',
    ...
    metaDescription: 'Как перенести сайт и домен к другому хостингу и регистратору без простоя: подготовка, перенос данных, смена DNS без даунтайма.',
  ...
  E({ slug: 'obnovit-staryy-sayt-2026', category: 'development', heroIcon: 'ph-fill ph-paint-brush-broad',
    ...
    metaDescription: 'Старый сайт устарел или тормозит: что выбрать — редизайн, пересборку с нуля или миграцию со старого PHP и 1С-Битрикс.',
  ...
  E({ slug: 'rezervnoe-kopirovanie-1c-2026', category: 'development', heroIcon: 'ph-fill ph-database',
    ...
    metaDescription: 'Резервное копирование 1С: как настроить автоматический бэкап базы, где хранить копии и перенести их в облако до сбоя или шифровальщика.',
  ...
  E({ slug: 'tehpodderzhka-sayta-skolko-stoit-2026', category: 'development', heroIcon: 'ph-fill ph-lifebuoy',
    ...
    metaDescription: 'Что входит в техподдержку сайта: обновления, бэкапы, безопасность, правки и мониторинг. Тарифы абонентки и почему она дешевле разовых обращений.',
  ...
  E({ slug: 'prihodyashchiy-sisadmin-vs-shtatnyy-2026', category: 'development', heroIcon: 'ph-fill ph-user-gear',
    ...
    metaDescription: 'Приходящий сисадмин или штатный в штате: чем отличаются по деньгам и рискам, что входит в IT-аутсорсинг для малого бизнеса.',
