...
module.exports = [
  E({ slug: 'putevye-listy-elektronno-2026', category: 'industries', heroIcon: 'ph-fill ph-file-text',
    ...
    metaDescription: 'Электронные путевые листы: кому обязательны, что нужно для перехода — ЭЦП, оператор ЭДО, интеграция — и как автоматизировать выпуск под свой автопарк.',
  ...
  E({ slug: 'programma-dlya-avtoservisa-2026', category: 'industries', heroIcon: 'ph-fill ph-wrench',
    ...
    metaTitle: 'Программа для автосервиса и СТО: что выбрать',
    metaDescription: 'Программа для автосервиса и СТО: запись клиентов, история по VIN, склад запчастей и напоминания о ТО. Обзор готовых решений или своя разработка под ключ.',
  ...
  E({ slug: 'programma-dlya-lombarda-2026', category: 'industries', heroIcon: 'ph-fill ph-vault',
    ...
    metaDescription: 'Программа для ломбарда: учёт залогов и займов, оценка, хранение, продажа невыкупа, отчётность в ЦБ и Росфинмониторинг. Когда нужна своя разработка.',
  ...
  E({ slug: 'vzlomali-sayt-chto-delat-2026', category: 'security', heroIcon: 'ph-fill ph-shield-warning',
    ...
    metaDescription: 'Взломали сайт — что делать: пошаговый план, как найти и удалить вирус, закрыть уязвимость, восстановить из бэкапа и защититься на будущее.',
  ...
  E({ slug: 'razrabotchik-propal-zabrat-sayt-2026', category: 'development', heroIcon: 'ph-fill ph-key',
    ...
    metaDescription: 'Разработчик пропал или не отдаёт сайт: как вернуть контроль над доменом, хостингом и админкой.',
  ...
  E({ slug: 'bot-s-bazoy-znaniy-rag-2026', category: 'ai-dev', heroIcon: 'ph-fill ph-brain',
    ...
    metaDescription: 'Бот с базой знаний на RAG: как ИИ отвечает клиентам и сотрудникам по вашим документам и регламентам без выдумок.',
