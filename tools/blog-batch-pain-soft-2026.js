...
module.exports = [
  ...
  E({ slug: 'programma-dlya-avtoservisa-2026', category: 'industries', heroIcon: 'ph-fill ph-wrench',
    ...
    metaDescription: 'Программа для автосервиса и СТО: заказ-наряды, запись, склад запчастей, история авто, зарплаты. Обзор готовых решений и когда нужна своя система.',
