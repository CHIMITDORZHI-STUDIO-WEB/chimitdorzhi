...
module.exports = [
  ...
  E({
    ...
    metaDescription: 'WHIEDA — что за компания прямых продаж (косметика, wellness): продукт, как устроен доход, признаки надёжности и как проверить её перед стартом. Без агитации.',
