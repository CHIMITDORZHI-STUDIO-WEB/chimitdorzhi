...
module.exports = [
  E({
    ...
    metaDescription: 'PM International и FitLine без обещаний дохода: что за компания, клеточное питание, как устроен заработок, кому подходит и какие есть риски.',
  ...
  E({
    ...
    metaDescription: 'FOHOW (Фохоу): что за компания, продукт (БАДы и продукты для здоровья на основе фитокомпонентов), как устроен бизнес и доход, кому подходит, плюсы и риски.',
  ...
  E({
    ...
    metaDescription: '4Life (Transfer Factor): что за компания, продукт (добавки линейки Трансфер Фактор), как устроен бизнес и доход, кому подходит, плюсы и риски.',
  ...
  E({
    ...
    metaTitle: 'М Интернешнл (M International): что это за компания — обзор',
    metaDescription: 'М Интернешнл (M International) — что это за компания прямых продаж: наливная парфюмерия, как устроен сетевой бизнес и доход, риски и как проверить её перед стартом.',
    metaKeywords: 'm international, м интернешнл, м интернейшнл, минтернешнл, м-интернешнл, м интернешнл что за компания, м интернешнл отзывы, m international бизнес, наливная парфюмерия сетевой, отзывы',
  ...
  E({
    ...
    metaDescription: 'EWA: компания прямых продаж в нише wellness — как устроен сетевой бизнес, как проверить и оценить малоизвестную компанию перед стартом (юрлицо, продукт.',
  ...
  E({
    ...
    metaDescription: 'Greenleaf (Гринлиф) без обещаний: как устроен сетевой бизнес в нише БАДов, как проверить компанию перед стартом, кому подходит и в чём риски.',
  ...
  E({
    ...
    metaTitle: 'Виеда (WHIEDA): отзывы реальные, что за компания, проверка',
    metaDescription: 'Виеда (WHIEDA) — что это за компания прямых продаж: продукт, как устроен доход, реальные отзывы, признаки надёжности и как проверить её перед стартом.',
    metaKeywords: 'whieda, whieda компания, whieda бизнес, whieda отзывы, виеда, виеда компания, виеда орг, виеда отзывы, виеда отзывы реальные, wieda, wieda отзывы, wieda.org, whieda.org, что за компания виеда, как проверить сетевую компанию',
