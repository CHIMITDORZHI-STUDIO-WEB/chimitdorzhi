...
module.exports = [
  ...
  E({
    ...
    metaDescription: 'М Интернешнл (M International) — что это за компания прямых продаж: наливная парфюмерия, как устроен сетевой бизнес и доход, риски и как проверить её до старта.',
