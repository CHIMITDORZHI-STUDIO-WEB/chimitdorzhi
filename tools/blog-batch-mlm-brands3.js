...
module.exports = [
  ...
  E({
    ...
    metaTitle: 'M International: честный обзор — плюсы, риски, кому подходит',
    metaDescription: 'M International: компания прямых продаж в нише парфюмерии и косметики — как устроен сетевой бизнес, как оценить компанию перед стартом, кому подходит.',
  ...
  E({
    ...
    metaTitle: 'WHIEDA: отзывы и обзор 2026 — что за компания и как проверить',
    metaDescription: 'WHIEDA — что это за компания прямых продаж (косметика, wellness): продукт, как устроен доход, признаки надёжности и как проверить компанию перед стартом. Разбор без агитации.',
