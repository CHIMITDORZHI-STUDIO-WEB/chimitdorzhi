...
module.exports = [
  mk({
    ...
    metaDescription: 'Обычный чат-бот забывает всё, как только диалог закончился, и клиент заново объясняет свою задачу. Как устроена долговременная память ИИ-агента, чем она отличается от базы знаний и как внедрить её у себя.',
  ...
  mk({
    ...
    metaDescription: 'Лицо человека на фото — персональные данные, публиковать их без согласия нельзя. Как автоматически размывать лица на снимках зала, объекта или мероприятия, чем это отличается от распознавания и как внедрить на своём сервере.',
