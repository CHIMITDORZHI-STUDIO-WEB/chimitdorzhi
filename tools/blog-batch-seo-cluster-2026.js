...
module.exports = [
  ...
  E({ slug: 'sponsorstvo-v-kibersporte-gayd-2026', category: 'esports', heroIcon: 'ph-fill ph-game-controller', ctaInternal: BRAND, servicesOffer: SVC_BIZ,
    ...
    metaDescription: 'Спонсорство в киберспорте: как бренду зайти, какие форматы бывают, на что смотреть в предложении организатора, как считать отдачу и не слить бюджет.',
