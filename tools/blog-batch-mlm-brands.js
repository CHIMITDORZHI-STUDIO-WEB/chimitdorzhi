...
module.exports = [
  E({
    ...
    metaDescription: 'Полный обзор сетевых (МЛМ) компаний, работающих в Бурятии, Забайкалье и Иркутске: российские и сибирские, международные, прямые продажи.',
  ...
  E({
    ...
    metaDescription: 'Сибирское здоровье (Siberian Wellness): что это, какой продукт (БАДы, питание, косметика), как устроен бизнес и доход, кому подходит, плюсы и риски.',
  ...
  E({
    ...
    metaDescription: 'Фаберлик 2026: что за компания, продукт и каталог, как устроен бизнес и доход, личный кабинет и как начать, кому подходит, плюсы и риски.',
  ...
  E({
    ...
    metaDescription: 'Гринвей (Greenway): что за компания, продукт (эко-товары, бытовая химия, фильтры), как устроен бизнес и доход, кому подходит, плюсы и риски, как начать.',
