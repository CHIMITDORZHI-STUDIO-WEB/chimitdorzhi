...
module.exports = [
  E({ slug: 'ii-dlya-internet-magazina-kartochki-tovarov-2026', heroIcon: 'ph-fill ph-storefront', ctaInternal: AUTO,
    ...
    metaDescription: 'Как интернет-магазину использовать ИИ-нейросети для генерации описаний и карточек товаров массово: SEO-тексты, характеристики, ответы на отзывы.',
  ...
  E({ slug: 'ai-agent-onlayn-zapis-na-uslugi-2026', heroIcon: 'ph-fill ph-calendar-check', ctaInternal: AGENTS,
    ...
    metaDescription: 'ИИ-агент для онлайн-записи на услуги: умный бот в Telegram, MAX и на сайте сам отвечает клиенту, подбирает время, записывает в расписание.',
  ...
  E({ slug: 'kiberbezopasnost-udalennoy-komandy-2026', heroIcon: 'ph-fill ph-shield-check', ctaInternal: SEC,
    ...
    metaDescription: 'Кибербезопасность удалённой и гибридной команды для малого бизнеса: менеджер паролей, двухфакторная аутентификация, защищённый доступ.',
  ...
  E({ slug: 'priem-oplaty-iz-za-rubezha-2026', heroIcon: 'ph-fill ph-currency-circle-dollar', ctaInternal: PRED,
    ...
    metaDescription: 'Обзор легальных способов принимать оплату от зарубежных клиентов в 2026 для бизнеса, фрилансера и IT: банки дружественных стран, платёжные агенты.',
  ...
  E({ slug: 'oblachnoe-hranilishche-dlya-biznesa-2026', heroIcon: 'ph-fill ph-cloud', ctaInternal: OS,
    ...
    metaDescription: 'Чужое облако или свой сервер для рабочих файлов: сравниваю цену, приватность, риски блокировок и 152-ФЗ на примере открытого Nextcloud.',
