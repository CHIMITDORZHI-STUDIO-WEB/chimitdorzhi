...
module.exports = [
  mk({
    ...
    metaDescription: 'HumHub — открытый корпоративный портал: лента, группы, база знаний, задачи, профили сотрудников — на своём сервере и без лицензий. Кому нужен интранет и как внедрить.',
  ...
  mk({
    ...
    metaDescription: 'FreePBX на базе Asterisk — своя виртуальная АТС: многоканальный номер, голосовое меню, запись звонков, распределение и статистика. На своём сервере, без абонплаты за каждого. Как внедрить.',
