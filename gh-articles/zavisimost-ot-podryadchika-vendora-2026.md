...
description: "Вендор-лок: код, доступы и данные заперты у одного подрядчика. Как ловушка возникает незаметно и что вернуть себе — репозиторий, документацию, сервер."
date: 2026-06-25
category: expert
