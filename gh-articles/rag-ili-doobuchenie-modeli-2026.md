...
Модели для поиска по документам (эмбеддинги и реранкеры) и языковые модели под дообучение собраны в [каталоге открытых ИИ-моделей](/ii-modeli/) — с лицензиями и требованиями к железу.
