...
**Коротко:** Ускорение сайта достигается на четырёх уровнях: снижение TTFB до 200 мс настройкой PHP-FPM, OPcache и MySQL; кэширование через Redis или Memcached; сокращение критического пути рендеринга (defer/async, критический CSS, font-display: swap); перевод изображений в WebP/AVIF. Для 1С-Битрикс дополнительно включают режим «Композитный сайт» и оптимизируют ORM-запросы.
