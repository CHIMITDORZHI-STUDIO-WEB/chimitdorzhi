...
**Свежий пример, июль 2026.** Публичные ссылки на диалоги в Claude оказались в поисковой выдаче: на страницах общих чатов не было запрета на индексацию, и роботы разобрали их наравне с обычными сайтами. В индекс попали API-ключи, персональные данные и внутренние документы компаний. Google скрыл такие ссылки превентивно, а Bing и Brave какое-то время продолжали их отдавать. Годом раньше в точно такую же историю попал ChatGPT.

Смысл не в том, что конкретный сервис плохой. Смысл в механике: сотрудник нажимает «поделиться диалогом», чтобы отправить ссылку коллеге, — и содержимое переписки становится доступно кому угодно, включая поисковики. Человек считает, что отправил ссылку одному человеку, а фактически опубликовал документ. Проверьте у себя раздел общих диалогов и удалите всё, что содержит рабочие данные.
