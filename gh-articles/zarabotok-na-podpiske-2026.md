...
**Коротко:** Подписка приносит регулярный доход (MRR), пока клиент платит месяц за месяцем, а не разово. Ключевая метрика — LTV: если она втрое выше стоимости привлечения клиента, модель работает. На старте реалистичны десятки тысяч рублей в месяц с первой сотни подписчиков, а дальше доход растёт за счёт удержания и снижения оттока не меньше, чем за счёт рекламы.
