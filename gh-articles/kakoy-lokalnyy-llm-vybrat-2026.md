...
Если нужен не только текст, но и распознавание речи, документов или генерация картинок, загляните в [каталоге открытых ИИ-моделей](/ii-modeli/): там больше двухсот семейств с 2022 года, у каждого задачи, требования к железу и лицензия.
