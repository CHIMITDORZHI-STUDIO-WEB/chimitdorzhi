...
**Коротко:** OpenAI, Claude и Gemini недоступны в России из-за блокировки оплаты и риска нарушить 152-ФЗ при обработке персональных данных. Замена — российский AI-стек: YandexGPT 5 Pro и GigaChat 3 Max по качеству на русском близки к GPT-4 Turbo, для изображений — Kandinsky 4 и YandexART 2, для self-hosting — Llama 3.3, Qwen 2.5, DeepSeek V3 на российских облаках.
