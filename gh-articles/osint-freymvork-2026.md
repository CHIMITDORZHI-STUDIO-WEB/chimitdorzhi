...
description: "OSINT Framework (осинт фреймворк) — что это: из каких разделов состоит карта инструментов, какие бесплатные сервисы брать под задачу и как искать законно."
date: 2026-06-19
category: security
...
Базовый навык, с которого всё начинается, — умение искать в обычном поисковике. Он разобран отдельно: [поисковые операторы, или Google-дорки](/blog/google-dorki-poiskovye-operatory-2026/).
...
**Коротко:** OSINT-фреймворк — это не набор инструментов, а каркас процесса: повторяемая последовательность из шести этапов — постановка задачи и границ, сбор из открытых источников, верификация и перекрёстная проверка, анализ и связи, отчёт, удаление лишних персональных данных. В основе — классический цикл разведки: планирование, сбор, обработка, анализ, распространение.
...
Раздел фреймворкаЧто ищемТиповые источникиЛюди и контактыимя, email, телефон, аккаунтыпоисковики, открытые профили, утечки-чекерыКомпаниивладельцы, финансы, суды, долгиЕГРЮЛ, картотека дел, ФССП, реестры лицензийДомены и сайтывладелец, история, инфраструктураwhois, архивы страниц, DNS-сервисыИзображенияпервоисточник, дата, местообратный поиск, метаданные снимкаГеографияадрес, объект, окружениекарты, панорамы, спутниковые снимкиДокументыпубликации, тендеры, отчётыгоспорталы, площадки закупок, архивы

Это не список «волшебных кнопок», а карта направлений: сначала вы понимаете, **что** именно ищете, и только потом подбираете под это источник.

Подробнее об этом я писал здесь: [Что такое OSINT простыми словами](/blog/chto-takoe-osint-2026/).
...
## Какие инструменты внутри каталога и для чего они

Сам OSINT Framework — это не программа, а дерево-каталог ссылок на открытые инструменты и источники. Он разбит на категории: вы раскрываете ветку под свою задачу и видите, какие сервисы относятся к этому направлению. Каталог ничего не ищет сам — он лишь подсказывает, куда смотреть. Поэтому важно понимать не конкретные сайты (они появляются и пропадают), а логику категорий.

Основные ветки каталога, если описывать их общими словами:

- **Имена пользователей и соцсети** — поиск публичных профилей и упоминаний по нику или названию.

- **Электронная почта** — проверка, существует ли адрес и к какому домену или сервису он относится.

- **Домены и IP-адреса** — сведения о регистрации домена, DNS-записях, сетевой инфраструктуре.

- **Изображения и геолокация** — обратный поиск картинок, карты, панорамы, метаданные снимков.

- **Организации и открытые реестры** — сведения о компаниях, судах, лицензиях, закупках.

- **Архивы веб-страниц** — как выглядел сайт раньше и что с него удалили.

- **Утечки** — сервисы, которые показывают, попадал ли ваш адрес или домен в известные утечки. Эту ветку уместно использовать только для проверки собственных данных.

КатегорияПример задачи для бизнесаОрганизации и реестрыпроверить контрагента перед сделкой: статус, суды, долгиДомены и IPнайти забытые поддомены и сайты своей компанииСоцсети и имена пользователейотследить упоминания бренда и поддельные аккаунты от его имениИзображениянайти, где без разрешения используют ваши фото товаровАрхивы страницвосстановить прежние условия на сайте партнёраУтечкипроверить, не засвечены ли корпоративные адреса сотрудников

Законные задачи для бизнеса укладываются в три группы: проверка контрагента (подробно — в статье про [проверку контрагентов и due diligence](/blog/proverka-kontragentov-due-diligence-2026/)), аудит собственного следа в сети и [мониторинг упоминаний компании](/blog/monitoring-upominaniy-kompanii-2026/). Во всех трёх случаях вы работаете либо с данными организаций, либо со своими собственными.

Чего делать нельзя: собирать и использовать персональные данные частных лиц без законного основания, составлять досье на людей, обходить защиту сервисов, пользоваться слитыми базами. То, что ссылка есть в каталоге, не делает законным любое её применение. Где проходит граница в вашей конкретной задаче, уточните у юриста до начала работы, а не после.
