...
description: "Токенизация металлов и цифровое золото: что такое токены, обеспеченные золотом или корзиной металлов, как устроены обеспечение, хранение и аудит."
date: 2026-06-23
category: expert
