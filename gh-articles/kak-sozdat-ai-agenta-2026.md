...
description: "Как создать и как сделать AI-агента с нуля: пошаговый гайд. Собираем первого агента без кода через n8n или на Claude API и YandexGPT — что выбрать."
date: 2026-06-13
category: ai-dev
...
Агент, который делает 20 итераций по 5000 токенов каждая, может стоить дорого в продакшне при высокой нагрузке. Считайте токены на этапе проектирования, не после запуска. Если считаете бюджет на заказную разработку, а не на самосбор, смотрите разбор [сколько стоит ИИ-агент и внедрение ИИ](/blog/vnedrenie-ii-stoimost-2027/), и отдельно — [ИИ-агент для сайта](/blog/ii-agent-zayavki-s-sayta-crm-2027/), который принимает заявки и заносит их в CRM.
