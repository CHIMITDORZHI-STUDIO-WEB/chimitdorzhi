...
description: "ЦФА и публичные блокчейны: что меняется, если регулируемые цифровые активы смогут «жить» в открытых реестрах, а не только в закрытых системах платформ."
date: 2026-06-23
category: expert
