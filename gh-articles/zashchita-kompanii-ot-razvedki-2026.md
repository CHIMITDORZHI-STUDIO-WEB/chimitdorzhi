...
description: "Как злоумышленники готовят атаку через разведку по открытым источникам (сайт, соцсети сотрудников, вакансии, утёкшие почты) и как этому помешать."
date: 2026-06-19
category: security
