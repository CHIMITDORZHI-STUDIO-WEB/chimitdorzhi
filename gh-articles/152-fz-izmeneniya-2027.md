...
description: "Что меняется в 152-ФЗ к 2027 году: согласия, уведомление Роскомнадзора, локализация данных, реагирование на утечки."
date: 2026-06-11
category: legal
...
Отдельно на эту тему: [Как проходит проверка Роскомнадзора по персональным данным в 2](/blog/proverka-roskomnadzora-kak-prohodit-2026/).
...
### Сколько времени занимает подготовка к 152-ФЗ для среднего бизнеса?

При осознанном подходе — несколько недель работы. Основная нагрузка приходится на инвентаризацию данных и переписывание согласий вместе с документами. После этого поддерживать всё в актуальном состоянии уже не требует больших затрат.
