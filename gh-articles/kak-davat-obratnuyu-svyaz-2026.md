...
description: "Как давать конструктивную обратную связь: модель SBI (ситуация-поведение-эффект), о фактах и поведении вместо личности, почему «бутерброд» не работает."
date: 2026-06-17
