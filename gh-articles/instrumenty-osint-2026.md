...
**Коротко:** Легальные инструменты OSINT делятся по задачам: операторы поиска, веб-архивы, официальные реестры, агрегаторы упоминаний, проверка изображений, анализ доменов и DNS, а также каталоги-навигаторы вроде OSINT Framework. Выбор всегда идёт от конкретной задачи — проверки контрагента, мониторинга репутации или защиты своих данных. Сомнительные «пробивные» сервисы и слитые базы к OSINT не относятся и незаконны.
