...
description: "Признаки того, что сотрудник копирует базу клиентов, легальные способы контроля (разграничение доступа, DLP) и что можно по 152-ФЗ, а что нельзя. С чего начать аудит доступа."
date: 2026-07-30
category: security
