...
description: "Юнит-экономика простыми словами: зарабатывает ли бизнес на одном клиенте. Ключевые метрики (CAC, LTV, маржа на юнит, окупаемость), формула и числовой пример, связь с точкой безубыточности и частые ошибки расчёта."
date: 2026-06-17
