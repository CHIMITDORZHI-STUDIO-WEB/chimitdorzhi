...
**Коротко:** IT-стек event- и свадебного агентства строится вокруг пяти блоков: CRM для длинной воронки (amoCRM, Bitrix24 или Notion/Airtable для соло), управление проектом с дедлайнами от даты события, калькулятор сметы, база подрядчиков и площадок с занятыми датами, тайминг-планировщик дня. Бюджет — от 2-8 тыс. ₽/мес соло-организатору до 30-90 тыс. ₽/мес агентству на 4-6 человек.
