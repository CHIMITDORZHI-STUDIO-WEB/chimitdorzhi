...
**Коротко:** Self-hosting выгоден командам от 5-10 человек — стек на Docker (Nextcloud, Gitea/Forgejo, n8n, Plausible/Umami, Vaultwarden) на российском VPS от 4 vCPU/8 ГБ RAM закрывает потребности малого бизнеса и автоматически решает вопрос локализации данных по 152-ФЗ. Экономия для команды от 20 человек — 100-300 тыс. ₽/год на горизонте 12-24 месяцев, при условии настроенных бэкапов и безопасности.
...
Смежная тема, которую я разбирал отдельно: [Услуги DevOps: сколько стоят и что входит в 2026](/blog/uslugi-devops-stoimost-2026/).
