...
description: "VROOM — open-source решатель маршрутизации (VRP): строит оптимальные маршруты для нескольких машин с учётом грузоподъёмности, окон доставки и времени водителей. Меньше пробег и число машин, данные у себя — внедрю под ключ."
date: 2026-06-16
category: opensource
