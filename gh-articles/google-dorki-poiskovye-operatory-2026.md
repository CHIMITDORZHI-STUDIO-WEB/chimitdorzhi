...
description: "Что такое дорки и как искать точно: оператор site: ищет только на одном сайте, filetype: — документы, кавычки — точную фразу. Работает в Google и Яндексе."
date: 2026-06-19
category: security
...
**Коротко:** Google-дорки — это поисковые операторы: короткие команды вроде site:, filetype:, кавычек и минуса, которые уточняют запрос и сужают выдачу до нужного результата. Они работают только с уже открытыми, проиндексированными страницами и не дают доступа к закрытым данным. Базовый набор почти одинаков в Google и Яндексе, а главная практическая польза — быстрый поиск документов, упоминаний и материалов, а также защитная проверка собственного сайта на предмет случайно попавшего в индекс лишнего.
...
Смежная тема, которую я разбирал отдельно: [Арсенал OSINT: обзор 100+ инструментов по направлениям (легаль](/blog/osint-arsenal-instrumenty-2026/).
...
**Оригинал статьи:** https://chimitdorzhi.tech/blog/google-dorki-poiskovye-operatory-2026/
