...
description: "Как легально проверить контрагента перед сделкой: ЕГРЮЛ и сервис ФНС, картотека арбитражных дел, банк данных ФССП, реестр недобросовестных поставщиков."
date: 2026-06-16
category: legal
...
Отдельно про инструментарий: какие открытые источники и сервисы для такой проверки существуют и как они устроены, я собрал в материале [OSINT-фреймворк: карта инструментов разведки по открытым источникам](/blog/osint-freymvork-2026/).
