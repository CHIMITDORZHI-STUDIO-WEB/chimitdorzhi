...
description: "Новое поколение OCR-моделей в 2026: распознают не только текст, но и структуру документов (таблицы, заголовки)."
date: 2026-06-25
category: ai-dev
...
Все открытые модели распознавания документов, с датами выхода и лицензиями, собраны в разделе «Документы и OCR» в [каталоге открытых ИИ-моделей](/ii-modeli/).
