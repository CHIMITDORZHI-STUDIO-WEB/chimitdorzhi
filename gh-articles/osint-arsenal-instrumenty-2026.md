...
description: "Легальный обзор OSINT-инструментов по направлениям: SOCMINT, GEOINT, сетевая разведка (whois/DNS своих активов), проверка изображений, мониторинг утечек."
date: 2026-06-19
category: security
...
**Коротко:** OSINT-арсенал — инструменты для работы с открытыми источниками: соцсети, геоданные, сетевая разведка, проверка изображений, мониторинг утечек, реестры. Сами по себе они нейтральны — легально проверять свои данные, оценивать контрагентов по реестрам, делать фактчекинг. Опасны массовые «наборы одной командой» — угроза безопасности. Выбирайте один проверенный инструмент под задачу, соблюдая 152-ФЗ и статью 137 УК.
...
**Про автоматизацию сбора.** Отдельный класс — комбайны, которые сами обходят десятки открытых источников и сводят найденное в одну картину. Самый известный с открытым кодом — SpiderFoot: он подключается к большому числу источников данных, работает через веб-интерфейс или командную строку и складывает результаты в единый отчёт. Такие инструменты экономят часы ручной работы, но именно поэтому с ними легче случайно выйти за рамки: сканирование чужой инфраструктуры без письменного разрешения владельца — это уже не разведка по открытым источникам. Я применяю их в двух сценариях: проверка собственного периметра компании и должная осмотрительность по контрагенту-юрлицу.
