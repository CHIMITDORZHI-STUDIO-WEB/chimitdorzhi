...
**Коротко:** шифрование превращает данные в набор символов, который прочитает только обладатель правильного ключа. Работает по двум схемам — симметричной с одним общим ключом и асимметричной с парой открытый-закрытый, — а на практике они дополняют друг друга. Встречаетесь с ним ежедневно: замочек HTTPS, банковское приложение, домашний Wi-Fi, память телефона, электронная подпись. Сквозное шифрование в мессенджерах прячет переписку даже от сервиса, но не скрывает факт общения.
