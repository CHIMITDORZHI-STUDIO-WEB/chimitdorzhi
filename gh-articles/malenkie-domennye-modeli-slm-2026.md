...
description: "Маленькие доменные модели (SLM) вместо одного гиганта: при настройке под конкретную задачу они так же точны или точнее, дешевле и быстрее. Угол импортозамещения и 152-ФЗ — модель на своём сервере в РФ, данные не уходят наружу. Как внедрить."
date: 2026-06-22
category: ai-dev
