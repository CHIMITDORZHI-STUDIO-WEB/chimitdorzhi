...
description: "Как один разработчик ведёт несколько проектов одновременно и не роняет качество: организация работы, приоритеты, где помогает ИИ, а где нужны только руки и голова."
date: 2026-07-31
