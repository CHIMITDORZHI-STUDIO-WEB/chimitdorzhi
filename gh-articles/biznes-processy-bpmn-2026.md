...
description: "Что такое бизнес-процесс и нотация BPMN простыми словами: события, задачи, шлюзы-развилки, дорожки. Как описать процесс по шагам (as-is, to-be) без переусложнения, связь с автоматизацией и частые ошибки. С примером."
date: 2026-06-17
category: biznes-krugozor
canonical: https://chimitdorzhi.tech/blog/biznes-processy-bpmn-2026/
---
...
**Оригинал статьи:** https://chimitdorzhi.tech/blog/biznes-processy-bpmn-2026/
