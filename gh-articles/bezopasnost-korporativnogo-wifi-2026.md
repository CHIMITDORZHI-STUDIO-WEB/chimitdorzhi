...
description: "Левые точки доступа, общая сеть с кассами и камерами, открытая гостевая сеть — как через Wi-Fi утекают данные и как это закрыть. Практическая настройка, а не теория."
date: 2026-07-30
category: security
