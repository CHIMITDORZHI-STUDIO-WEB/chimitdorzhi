...
Чтобы понять, что именно запускать на выбранной видеокарте, откройте [каталоге открытых ИИ-моделей](/ii-modeli/) и отфильтруйте по железу: «ноутбук», «одна видеокарта» или «кластер».
