...
**Коротко:** защита от шифровальщика строится на нескольких мерах: делайте резервные копии по правилу 3-2-1 с офлайн- или неизменяемой копией, закройте три главных входа для атак — фишинг, открытый удалённый доступ (RDP/VPN) и непропатченные уязвимости, включите многофакторную аутентификацию, сегментируйте сеть и обучите сотрудников. Выкуп платить нельзя: гарантий нет, а бэкап — единственная надёжная защита.
