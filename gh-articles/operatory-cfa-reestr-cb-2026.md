...
description: "Операторы ЦФА: кто такие операторы информационных систем и операторы обмена, как устроен рынок, как читать и проверять реестр Банка России перед работой с платформой и как выбрать площадку. Список меняется — сверяйтесь с cbr.ru. Образовательный разбор."
date: 2026-06-23
category: expert
canonical: https://chimitdorzhi.tech/blog/operatory-cfa-reestr-cb-2026/
---
...
**Коротко:** Операторы ЦФА — это компании, чьи информационные системы используются для выпуска и учёта цифровых финансовых активов, а работать легально они могут только после включения в реестр Банка России. Есть два типа операторов: информационных систем — выпуск и хранение активов, и обмена — организация сделок купли-продажи. Актуальный список публикует cbr.ru, и проверять платформу нужно именно там.
...
Если вы только присматриваетесь к теме и хотите выпустить ЦФА для своего бизнеса, я помогаю разобраться в процессе и подобрать платформу под конкретную задачу — об этом можно почитать на странице [сопровождения выпуска ЦФА](https://chimitdorzhi.tech/services/cfa-issuance/). А посмотреть другие форматы работы и услуги удобно в разделе [с предложениями](https://chimitdorzhi.tech/predlozheniya/).
...
**Разве все операторы ЦФА — это банки?** Нет. Среди операторов есть и крупные банки, и специализированные технологические платформы, не являющиеся кредитными организациями. Если оператор — банк, это обычно отражено в его статусе. Полный перечень я сознательно не привожу: он меняется, и правильнее смотреть актуальный реестр на cbr.ru.
...
**Оригинал статьи:** https://chimitdorzhi.tech/blog/operatory-cfa-reestr-cb-2026/
