...
# Куда ведёт реклама: почему без сайта бюджет сливается
...
**Коротко:** Бюджет сливается не из-за плохой рекламы, а из-за страницы, на которую она ведёт. Сайт, готовый принимать рекламный трафик, за несколько секунд объясняет предложение и цену, показывает явную кнопку заявки, грузится на телефоне за две-три секунды и не отвлекает лишними разделами вроде истории компании и вакансий на той же странице.
...
**Сколько полей должно быть в форме заявки на посадочной странице?** На первом шаге почти всегда достаточно имени и телефона — остальные детали можно уточнить в разговоре с клиентом. Чем длиннее форма, тем больше людей закрывают её на середине заполнения.

**Как проверить, что форма заявки на сайте вообще работает?** Раз в одну-две недели самостоятельно оформляйте тестовую заявку через форму на своём сайте и проверяйте, что она действительно доходит до вас. Форма может выглядеть красиво, но отправлять данные в никуда из-за ошибки в коде или сломанной интеграции с CRM.
