...
description: "Закон Гудхарта простыми словами: когда метрика становится целью, она перестаёт быть хорошей метрикой. Почему люди начинают накручивать показатель, классические примеры, метрики тщеславия и как от этого защититься."
date: 2026-06-17
