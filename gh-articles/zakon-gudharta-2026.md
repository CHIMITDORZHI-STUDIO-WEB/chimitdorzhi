...
description: "Закон Гудхарта простыми словами: когда метрика становится целью, она перестаёт быть хорошей метрикой."
date: 2026-06-17
category: biznes-krugozor
canonical: https://chimitdorzhi.tech/blog/zakon-gudharta-2026/
---
...
Подробнее об этом я писал здесь: [KPI: что это и как правильно ставить](/blog/kpi-chto-eto-kak-stavit-2026/).
...
Подробнее об этом я писал здесь: [Balanced Scorecard: сбалансированная система показателей прост](/blog/balanced-scorecard-2027/).
...
**Оригинал статьи:** https://chimitdorzhi.tech/blog/zakon-gudharta-2026/
