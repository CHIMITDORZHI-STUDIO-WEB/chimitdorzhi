...
**Коротко:** кибергигиена сотрудников — это простые повторяемые привычки (менеджер паролей, обязательная 2FA, своевременные обновления, блокировка экрана, VPN в публичных сетях) и регулярное обучение с фишинг-симуляциями, которые защищают компанию от главного источника инцидентов — ошибок человека. Более 80% атак идут через фишинг, вишинг, смишинг и социальную инженерию, а по 152-ФЗ за утечку персональных данных отвечает компания, а не конкретный сотрудник.
