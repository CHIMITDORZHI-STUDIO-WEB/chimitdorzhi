...
description: "Путь потребителя по McKinsey: круг вместо воронки — рассмотрение, оценка, покупка, петля лояльности. Чем отличается от воронки и CJM, как применить."
date: 2026-06-17
