...
description: "Что можно узнать о человеке по открытым источникам, а что уже статья. Граница между OSINT и пробивом, требования 152-ФЗ и проверка людей при найме."
date: 2026-07-20
category: security
