...
**Коротко:** О компании можно узнать метаданные документов и фото, забытые поддомены и открытые папки на сайте, кэш поисковиков, реквизиты и данные сотрудников в соцсетях, а также утёкшие через сторонние сервисы рабочие email и пароли. Эти фрагменты складываются в материал для фишинга и атак на инфраструктуру. Закрыть большинство дыр можно организационными мерами: очисткой данных, аудитом поддоменов и сменой паролей.
