...
description: "Что компания невольно публикует о себе в открытых источниках: метаданные документов, открытые папки, утёкшие пароли сотрудников, реквизиты в соцсетях."
date: 2026-06-16
category: security
