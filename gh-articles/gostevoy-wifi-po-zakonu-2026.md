...
description: "Гостевой Wi-Fi в кафе, отеле, салоне: почему нельзя просто раздать пароль, что требует закон об идентификации пользователей публичных сетей, как настроить авторизацию и изолировать гостей от кассы."
date: 2026-07-22
category: legal
