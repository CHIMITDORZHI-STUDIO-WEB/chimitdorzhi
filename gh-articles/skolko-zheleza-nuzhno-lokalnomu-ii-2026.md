...
description: "Сколько железа нужно для локального ИИ: разбор по VRAM, RAM и квантизации."
date: 2026-06-25
category: ai-dev
...
В [каталоге открытых ИИ-моделей](/ii-modeli/) есть фильтр по железу: можно сразу отобрать модели, которым хватит ноутбука, одной видеокарты или нужен сервер с несколькими GPU.
