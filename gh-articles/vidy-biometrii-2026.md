...
**Коротко:** Основные виды биометрии — лицо, голос, отпечаток пальца и радужка глаза, а также более редкие сетчатка и рисунок вен ладони. Лицо и голос подходят для дистанционной идентификации, отпечаток — для физического доступа, радужка и сетчатка — для объектов с повышенной защитой. Даже если система хранит не изображение, а математический вектор, это всё равно биометрические персональные данные по 152-ФЗ.
