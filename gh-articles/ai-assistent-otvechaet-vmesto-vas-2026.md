...
**Коротко:** AI-ассистент отличается от обычного бота тем, что не выбирает готовый текст из дерева кнопок, а формулирует ответ заново на основе загруженных документов, прайсов и базы знаний бизнеса. Он экономит время команды на консультациях и FAQ, но в юридических, медицинских и финансовых темах ответ всё равно должен проверять человек, а не ассистент.
...
**Сколько времени нужно на подготовку базы знаний перед запуском?** На структурирование информации для среднего бизнеса — услуги, цены, условия, частые вопросы — уходит от 8 до 20 часов работы, и значительную часть этой работы должен выполнять человек, который ближе всего к клиентам, а не только подрядчик.

**Как проверить ассистента перед запуском на реальных клиентов?** Стоит прогнать его через контрольный набор из 40-60 реальных вопросов клиентов за последние два-три месяца, включая пограничные и провокационные формулировки, и отмечать в таблице, какие ответы получились нормальными, а какие спорными или плохими.
