...
**Коротко:** Метаданные — служебная информация внутри файла: у фото это EXIF с датой, временем, моделью устройства и GPS-координатами места съёмки при включённой геопривязке, у документов Word и PDF — имя автора, история правок, комментарии и путь к файлу на компьютере. Публикация без чистки раскрывает адрес, маршрут или внутреннюю кухню компании; чистить нужно перед каждой отправкой.
