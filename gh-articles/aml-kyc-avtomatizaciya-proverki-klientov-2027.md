...
**Коротко:** AML/KYC-проверку клиентов можно автоматизировать почти полностью: распознавание документов, сверку со списками через API, риск-скоринг по правилам, флаги подозрительных операций и отчёты система берёт на себя, а человек — комплаенс-офицер — принимает решение только по спорным случаям. Ключевой принцип: флаги для человека, а не жёсткие автоблокировки, что снижает число ложных срабатываний.
