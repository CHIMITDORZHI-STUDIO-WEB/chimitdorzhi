...
description: "AR.js — open-source дополненная реальность в браузере (по маркеру, изображению, геолокации) без установки приложения: оживающая упаковка, AR-визитка."
date: 2026-06-16
category: opensource
