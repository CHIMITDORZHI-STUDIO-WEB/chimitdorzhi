...
description: "ABC-анализ простыми словами: деление товаров и клиентов на группы A, B, C по вкладу в выручку."
date: 2026-06-17
...
Подробнее об этом я писал здесь: [Когортный анализ простыми словами](/blog/kogortnyy-analiz-2026/).
