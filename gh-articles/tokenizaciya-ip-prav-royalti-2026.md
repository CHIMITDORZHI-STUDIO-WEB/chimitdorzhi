...
description: "Токенизация IP-прав и роялти: как автор, музыкант, патентообладатель или студия выпускает ЦФА на долю будущих роялти, не передавая исключительное право."
date: 2026-06-23
category: expert
