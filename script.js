...
(function(){
  ...
  /* .wx-rail-top — прокручиваемая часть: логотип, поиск, навигация.
     Блок CTA и соцсети идут после неё и закреплены внизу (см. style.css),
     иначе на невысоких экранах их срезало нижней границей сайдбара. */
